...
import { getPadMatMedState, IPadMatMedBaseState, getEntitiesExport } from '../pad-mat-med.reducer';
...
export class PadMatMed extends React.Component<IPadMatMedProps, IPadMatMedState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPad, idMatMed, qtd, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
