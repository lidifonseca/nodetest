...
import { getMigracaoState, IMigracaoBaseState, getEntitiesExport } from '../migracao.reducer';
...
export class Migracao extends React.Component<IMigracaoProps, IMigracaoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPad, dataHoraMigracao, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
