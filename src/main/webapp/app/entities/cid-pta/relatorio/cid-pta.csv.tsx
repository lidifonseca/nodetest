...
import { getCidPtaState, ICidPtaBaseState, getEntitiesExport } from '../cid-pta.reducer';
...
export class CidPta extends React.Component<ICidPtaProps, ICidPtaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idDescPta, idCid, idAtividade, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
