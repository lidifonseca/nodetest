...
import { getImagemProntuarioState, IImagemProntuarioBaseState, getEntitiesExport } from '../imagem-prontuario.reducer';
...
export class ImagemProntuario extends React.Component<IImagemProntuarioProps, IImagemProntuarioState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idProntuario, imagem, ativo, diretorio, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
