...
import ImagemProntuarioRelatorioCSV from './relatorio/imagem-prontuario.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ImagemProntuarioRelatorioCSV} />
