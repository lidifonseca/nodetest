...
export const Incidente = (props: IIncidenteProps) => {
  ...
  const { incidenteList, match, loading, totalItems } = props;
  return (
    <div>
      ...
      <div className="table-responsive">
        {incidenteList && incidenteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('recebedoEm')}>
                  Recebedo Em <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${incidente.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${incidente.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          !loading && <div className="alert alert-warning">No Incidentes found</div>
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Incidente);
