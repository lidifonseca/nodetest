...
import AtendimentoAssinaturasRelatorioCSV from './relatorio/atendimento-assinaturas.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={AtendimentoAssinaturasRelatorioCSV} />
