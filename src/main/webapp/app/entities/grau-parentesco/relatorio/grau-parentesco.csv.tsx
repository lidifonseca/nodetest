...
import { getGrauParentescoState, IGrauParentescoBaseState, getEntitiesExport } from '../grau-parentesco.reducer';
...
export class GrauParentesco extends React.Component<IGrauParentescoProps, IGrauParentescoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(grauParentesco, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
