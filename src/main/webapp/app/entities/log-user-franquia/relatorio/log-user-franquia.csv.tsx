...
import { getLogUserFranquiaState, ILogUserFranquiaBaseState, getEntitiesExport } from '../log-user-franquia.reducer';
...
export class LogUserFranquia extends React.Component<ILogUserFranquiaProps, ILogUserFranquiaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(descricao, acao, tela, usuario, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
