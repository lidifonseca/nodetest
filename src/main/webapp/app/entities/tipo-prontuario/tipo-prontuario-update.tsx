...
import {
  ITipoProntuarioUpdateState,
  getEntity,
  getTipoProntuarioState,
  ITipoProntuarioBaseState,
  updateEntity,
  createEntity,
  reset
} from './tipo-prontuario.reducer';
...
export class TipoProntuarioUpdate extends React.Component<ITipoProntuarioUpdateProps, ITipoProntuarioUpdateState> {
  ...
  getFiltersURL = (offset = null) => {
    ...
    return (
      ...
      (fieldsBase['prontuario'] ? '&prontuario=' + fieldsBase['prontuario'] : '') +
  ...
  handleClose = () => {
    this.props.history.push('/tipo-prontuario?' + this.getFiltersURL());
  };
            ...
            <PanelHeader>
              <h2 id="page-heading">
                ...
                <Button
                  tag={Link}
                  id="cancel-save"
                  to={'/tipo-prontuario?' + this.getFiltersURL()}
                  replace
                  color="info"
