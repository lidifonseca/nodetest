...
import TipoProntuarioRelatorioCSV from './relatorio/tipo-prontuario.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={TipoProntuarioRelatorioCSV} />
