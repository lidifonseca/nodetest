...
import { getTipoProntuarioState, ITipoProntuarioBaseState, getEntitiesExport } from '../tipo-prontuario.reducer';
...
export class TipoProntuario extends React.Component<ITipoProntuarioProps, ITipoProntuarioState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(prontuario, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
