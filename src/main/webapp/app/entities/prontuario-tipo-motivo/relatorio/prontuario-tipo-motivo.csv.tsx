...
import { getProntuarioTipoMotivoState, IProntuarioTipoMotivoBaseState, getEntitiesExport } from '../prontuario-tipo-motivo.reducer';
...
export class ProntuarioTipoMotivo extends React.Component<IProntuarioTipoMotivoProps, IProntuarioTipoMotivoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nome, idPai, ativo, classe, name, idTipoProntuario, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
