            ...
            <PanelHeader>
              <h2 id="page-heading">
                <span className="page-header ml-3">
                  <Translate contentKey="generadorApp.usuarioStatusAtual.home.createOrEditLabel">
                    Create or edit a UsuarioStatusAtual
                  </Translate>
                </span>
                    ...
                    <Row>
                      ...
                      <Col md="12">
                        <AvGroup>
                          <Row>
                            <Col md="3">
                              <Label className="mt-2" id="dataPostLabel" for="usuario-status-atual-dataPost">
                            ...
                            <Col md="9">
                              <AvInput
                                ...
                                value={isNew ? null : convertDateTimeFromServer(this.props.usuarioStatusAtualEntity.dataPost)}
                                validate={{
