...
import UsuarioStatusAtualRelatorioCSV from './relatorio/usuario-status-atual.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={UsuarioStatusAtualRelatorioCSV} />
