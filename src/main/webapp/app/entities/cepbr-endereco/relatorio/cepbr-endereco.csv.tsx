...
import { getCepbrEnderecoState, ICepbrEnderecoBaseState, getEntitiesExport } from '../cepbr-endereco.reducer';
...
export class CepbrEndereco extends React.Component<ICepbrEnderecoProps, ICepbrEnderecoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(cep, logradouro, tipoLogradouro, complemento, local, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
