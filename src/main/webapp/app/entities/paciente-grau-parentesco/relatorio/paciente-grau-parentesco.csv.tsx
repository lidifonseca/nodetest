...
import { getPacienteGrauParentescoState, IPacienteGrauParentescoBaseState, getEntitiesExport } from '../paciente-grau-parentesco.reducer';
...
export class PacienteGrauParentesco extends React.Component<IPacienteGrauParentescoProps, IPacienteGrauParentescoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(grauParentesco, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
