...
import { getEntity, updateEntity, createEntity, reset } from './grupo-risco.reducer';
...
export class GrupoRiscoUpdate extends React.Component<IGrupoRiscoUpdateProps, IGrupoRiscoUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/grupo-risco');
  };
          ...
          <Panel>
            <PanelHeader>
              <h2 id="page-heading">
                ...
                <Button tag={Link} id="cancel-save" to="/grupo-risco" replace color="info" className="float-right jh-create-entity">
                    ...
                    <Row>
                      ...
                      <Col md="12">
                        <AvGroup>
                          <Row>
                            <Col md="3">
                              <Label className="mt-2" id="dataPostLabel" for="grupo-risco-dataPost">
                            ...
                            <Col md="9">
                              <AvInput
                                ...
                                value={isNew ? null : convertDateTimeFromServer(this.props.grupoRiscoEntity.dataPost)}
                                validate={{
