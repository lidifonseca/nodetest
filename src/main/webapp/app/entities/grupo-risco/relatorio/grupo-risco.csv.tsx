...
import { getGrupoRiscoState, IGrupoRiscoBaseState, getEntitiesExport } from '../grupo-risco.reducer';
...
export class GrupoRisco extends React.Component<IGrupoRiscoProps, IGrupoRiscoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(grupoRisco, styleLabel, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
