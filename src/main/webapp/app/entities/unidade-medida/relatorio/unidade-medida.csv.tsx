...
import { getUnidadeMedidaState, IUnidadeMedidaBaseState, getEntitiesExport } from '../unidade-medida.reducer';
...
export class UnidadeMedida extends React.Component<IUnidadeMedidaProps, IUnidadeMedidaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(unidade, descricao, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
