...
import UnidadeMedidaRelatorioCSV from './relatorio/unidade-medida.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={UnidadeMedidaRelatorioCSV} />
