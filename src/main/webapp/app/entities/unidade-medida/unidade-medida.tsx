...
import { getEntities } from './unidade-medida.reducer';
...
export class UnidadeMedida extends React.Component<IUnidadeMedidaProps, IUnidadeMedidaState> {
  ...
  constructor(props: IUnidadeMedidaProps) {
    ...
    this.state = {
      ...
      ...this.getUnidadeMedidaState(this.props.location)
    };
  }

  getUnidadeMedidaState = (location): IUnidadeMedidaBaseState => {
                  ...
                  <tbody>
                    ...
                    {unidadeMedidaList.map((unidadeMedida, i) => (
                      <tr key={`entity-${i}`}>
                        ...
                        <td>{unidadeMedida.descricao}</td>

                        <td className="text-right">
                          <div className="btn-group flex-btn-group-container">
                            <Button tag={Link} to={`${match.url}/${unidadeMedida.id}`} color="info" size="sm">
                              <FontAwesomeIcon icon="eye" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.view">View</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${unidadeMedida.id}/edit`} color="primary" size="sm">
                              <FontAwesomeIcon icon="pencil-alt" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.edit">Edit</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${unidadeMedida.id}/delete`} color="danger" size="sm">
