...
import { getApiInputState, IApiInputBaseState, getEntitiesExport } from '../api-input.reducer';
...
export class ApiInput extends React.Component<IApiInputProps, IApiInputState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idApiName, apiInput, apiType, obs, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
