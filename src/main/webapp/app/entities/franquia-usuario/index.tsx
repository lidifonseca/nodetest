...
import FranquiaUsuarioRelatorioCSV from './relatorio/franquia-usuario.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={FranquiaUsuarioRelatorioCSV} />
