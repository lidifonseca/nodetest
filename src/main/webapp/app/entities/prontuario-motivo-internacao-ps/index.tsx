...
import ProntuarioMotivoInternacaoPsRelatorioCSV from './relatorio/prontuario-motivo-internacao-ps.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProntuarioMotivoInternacaoPsRelatorioCSV} />
