...
import { getProfissionalHorarioState, IProfissionalHorarioBaseState, getEntitiesExport } from '../profissional-horario.reducer';
...
export class ProfissionalHorario extends React.Component<IProfissionalHorarioProps, IProfissionalHorarioState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idAtendimento, idProfissional, horario, confirm, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
