...
import ProfissionalHorarioRelatorioCSV from './relatorio/profissional-horario.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalHorarioRelatorioCSV} />
