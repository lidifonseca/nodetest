...
import { getOcorrenciaProntuarioState, IOcorrenciaProntuarioBaseState, getEntitiesExport } from '../ocorrencia-prontuario.reducer';
...
export class OcorrenciaProntuario extends React.Component<IOcorrenciaProntuarioProps, IOcorrenciaProntuarioState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nome, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
