...
import { getDiarioTagsState, IDiarioTagsBaseState, getEntitiesExport } from '../diario-tags.reducer';
...
export class DiarioTags extends React.Component<IDiarioTagsProps, IDiarioTagsState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nome, idPai, nomeId, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
