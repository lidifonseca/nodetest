...
import { getReportEmailAtendimentoState, IReportEmailAtendimentoBaseState, getEntitiesExport } from '../report-email-atendimento.reducer';
...
export class ReportEmailAtendimento extends React.Component<IReportEmailAtendimentoProps, IReportEmailAtendimentoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idAtendimento, tipoReport, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
