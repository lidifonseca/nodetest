...
import { getModulosPadConfigState, IModulosPadConfigBaseState, getEntitiesExport } from '../modulos-pad-config.reducer';
...
export class ModulosPadConfig extends React.Component<IModulosPadConfigProps, IModulosPadConfigState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idModulosPad, idEspecialidade, idPeriodicidade, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
