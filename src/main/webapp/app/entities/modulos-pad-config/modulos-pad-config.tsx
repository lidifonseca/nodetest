...
export class ModulosPadConfig extends React.Component<IModulosPadConfigProps, IModulosPadConfigState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="page-heading">
          <span className="page-header">Modulos Pad Configs</span>
          <Button id="togglerFilterModulosPadConfig" className="btn btn-primary float-right jh-create-entity">
            <Translate contentKey="generadorApp.modulosPadConfig.home.btn_filter_open">Filters</Translate>
            &nbsp;
                  ...
                  <AvForm ref={el => (this.myFormRef = el)} id="form-filter" onSubmit={this.filterEntity}>
                    ...
                    <div className="row mb-2 mr-4 justify-content-end">
                      <Button className="btn btn-success" type="submit">
                        ...
                        &nbsp;
                        <Translate contentKey="generadorApp.modulosPadConfig.home.btn_filter">Filter</Translate>
                      </Button>
                      &nbsp;
                      <div className="btn btn-secondary hand" onClick={this.cancelCourse}>
                        <FontAwesomeIcon icon="trash-alt" />
                        &nbsp;
                        <Translate contentKey="generadorApp.modulosPadConfig.home.btn_filter_clean">Clean</Translate>
                      </div>
                    </div>
                  </AvForm>
                </CardBody>
