...
import { getProfissionalFranquiaState, IProfissionalFranquiaBaseState, getEntitiesExport } from '../profissional-franquia.reducer';
...
export class ProfissionalFranquia extends React.Component<IProfissionalFranquiaProps, IProfissionalFranquiaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idProfissional, idFranquia, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
