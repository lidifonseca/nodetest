                ...
                <Col md="8">
                  {loading ? (
                    ...
                    <div>
                      ...
                      <Row>
                        <VerCronicosComponentUpdate baseFilters />

                        <VerPacientesAtivosCrComponentUpdate baseFilters />

                        <FiltroPacientesAtivosCrComponentUpdate baseFilters />

                        <VerNumHospCrComponentUpdate baseFilters />

                        <FiltroNumHospCrComponentUpdate baseFilters />

                        <VerNumDesospCrComponentUpdate baseFilters />

                        <FiltroNumDesospCrComponentUpdate baseFilters />

                        <VerNumPsCrComponentUpdate baseFilters />

                        <FiltroNumPsCrComponentUpdate baseFilters />

                        <VerNumObitoCrComponentUpdate baseFilters />

                        <FiltroNumObitoCrComponentUpdate baseFilters />

                        <VerIndCliEstaveisCrComponentUpdate baseFilters />

                        <FiltroIndCliEstaveisCrComponentUpdate baseFilters />

                        <VerNumConsMedInternasCrComponentUpdate baseFilters />

                        <FiltroNumConsMedInternasCrComponentUpdate baseFilters />

                        <VerNumConsMedExternasCrComponentUpdate baseFilters />

                        <FiltroNumConsMedExternasCrComponentUpdate baseFilters />

                        <VerNumLaboratorialCrComponentUpdate baseFilters />

                        <FiltroNumLaboratorialCrComponentUpdate baseFilters />

                        <VerNumImagemCrComponentUpdate baseFilters />

                        <FiltroNumImagemCrComponentUpdate baseFilters />

                        <VerNumOutrosCrComponentUpdate baseFilters />

                        <FiltroNumOutrosCrComponentUpdate baseFilters />

                        <VerNumAtCatCrComponentUpdate baseFilters />

                        <FiltroNumAtCatCrComponentUpdate baseFilters />

                        <VerNumCatCompCrComponentUpdate baseFilters />

                        <FiltroNumCatCompCrComponentUpdate baseFilters />

                        <VerAtCmSucessoCrComponentUpdate baseFilters />

                        <FiltroAtCmSucessoCrComponentUpdate baseFilters />

                        <VerMediaPadAbertoCrComponentUpdate baseFilters />

                        <FiltroMediaPadAbertoCrComponentUpdate baseFilters />

                        <VerAtIntercorrenciaCrComponentUpdate baseFilters />

                        <FiltroAtIntercorrenciaCrComponentUpdate baseFilters />

                        <VerTempoMedioAtCrComponentUpdate baseFilters />

                        <FiltroTempoMedioAtCrComponentUpdate baseFilters />

                        <VerMediaPtaCrComponentUpdate baseFilters />

                        <FiltroMediaPtaCrComponentUpdate baseFilters />

                        <VerIndicadorUsoAppCrComponentUpdate baseFilters />

                        <FiltroIndicadorUsoAppCrComponentUpdate baseFilters />
                      </Row>
                    </div>
                  )}
                </Col>
...
const VerCronicosComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verCronicos' ? (
    <Col md="verCronicos">
      <AvGroup>
        <Row>
          <Col md="3">
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verCronicos" type="string" className="form-control" name="verCronicos" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerPacientesAtivosCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verPacientesAtivosCr' ? (
...
const FiltroPacientesAtivosCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroPacientesAtivosCr' ? (
    <Col md="filtroPacientesAtivosCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroPacientesAtivosCrLabel" for="usuario-painel-gerencial-filtroPacientesAtivosCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroPacientesAtivosCr">Filtro Pacientes Ativos Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerNumHospCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumHospCr' ? (
    <Col md="verNumHospCr">
      <AvGroup>
        <Row>
          <Col md="3">
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumHospCr" type="string" className="form-control" name="verNumHospCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumHospCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumHospCr' ? (
    <Col md="filtroNumHospCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumHospCr" type="string" className="form-control" name="filtroNumHospCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumDesospCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumDesospCr' ? (
    <Col md="verNumDesospCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumDesospCr" type="string" className="form-control" name="verNumDesospCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumDesospCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumDesospCr' ? (
    <Col md="filtroNumDesospCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumDesospCr" type="string" className="form-control" name="filtroNumDesospCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumPsCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumPsCr' ? (
    <Col md="verNumPsCr">
      <AvGroup>
        <Row>
          <Col md="3">
...
const FiltroNumPsCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumPsCr' ? (
    <Col md="filtroNumPsCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumPsCr" type="string" className="form-control" name="filtroNumPsCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumObitoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumObitoCr' ? (
    <Col md="verNumObitoCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumObitoCr" type="string" className="form-control" name="verNumObitoCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumObitoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumObitoCr' ? (
    <Col md="filtroNumObitoCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumObitoCr" type="string" className="form-control" name="filtroNumObitoCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerIndCliEstaveisCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verIndCliEstaveisCr' ? (
    <Col md="verIndCliEstaveisCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verIndCliEstaveisCr" type="string" className="form-control" name="verIndCliEstaveisCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroIndCliEstaveisCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroIndCliEstaveisCr' ? (
    <Col md="filtroIndCliEstaveisCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroIndCliEstaveisCrLabel" for="usuario-painel-gerencial-filtroIndCliEstaveisCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroIndCliEstaveisCr">Filtro Ind Cli Estaveis Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerNumConsMedInternasCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumConsMedInternasCr' ? (
    <Col md="verNumConsMedInternasCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="verNumConsMedInternasCrLabel" for="usuario-painel-gerencial-verNumConsMedInternasCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.verNumConsMedInternasCr">Ver Num Cons Med Internas Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const FiltroNumConsMedInternasCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumConsMedInternasCr' ? (
    <Col md="filtroNumConsMedInternasCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroNumConsMedInternasCrLabel" for="usuario-painel-gerencial-filtroNumConsMedInternasCr">
...
const VerNumConsMedExternasCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumConsMedExternasCr' ? (
    <Col md="verNumConsMedExternasCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="verNumConsMedExternasCrLabel" for="usuario-painel-gerencial-verNumConsMedExternasCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.verNumConsMedExternasCr">Ver Num Cons Med Externas Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const FiltroNumConsMedExternasCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumConsMedExternasCr' ? (
    <Col md="filtroNumConsMedExternasCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroNumConsMedExternasCrLabel" for="usuario-painel-gerencial-filtroNumConsMedExternasCr">
...
const VerNumLaboratorialCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumLaboratorialCr' ? (
...
const FiltroNumLaboratorialCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumLaboratorialCr' ? (
    <Col md="filtroNumLaboratorialCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroNumLaboratorialCrLabel" for="usuario-painel-gerencial-filtroNumLaboratorialCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroNumLaboratorialCr">Filtro Num Laboratorial Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerNumImagemCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumImagemCr' ? (
    <Col md="verNumImagemCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumImagemCr" type="string" className="form-control" name="verNumImagemCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumImagemCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumImagemCr' ? (
    <Col md="filtroNumImagemCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumImagemCr" type="string" className="form-control" name="filtroNumImagemCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumOutrosCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumOutrosCr' ? (
    <Col md="verNumOutrosCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumOutrosCr" type="string" className="form-control" name="verNumOutrosCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumOutrosCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumOutrosCr' ? (
    <Col md="filtroNumOutrosCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumOutrosCr" type="string" className="form-control" name="filtroNumOutrosCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumAtCatCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumAtCatCr' ? (
    <Col md="verNumAtCatCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumAtCatCr" type="string" className="form-control" name="verNumAtCatCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumAtCatCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumAtCatCr' ? (
    <Col md="filtroNumAtCatCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumAtCatCr" type="string" className="form-control" name="filtroNumAtCatCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerNumCatCompCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verNumCatCompCr' ? (
    <Col md="verNumCatCompCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verNumCatCompCr" type="string" className="form-control" name="verNumCatCompCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroNumCatCompCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroNumCatCompCr' ? (
    <Col md="filtroNumCatCompCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroNumCatCompCr" type="string" className="form-control" name="filtroNumCatCompCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerAtCmSucessoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verAtCmSucessoCr' ? (
    <Col md="verAtCmSucessoCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verAtCmSucessoCr" type="string" className="form-control" name="verAtCmSucessoCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroAtCmSucessoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroAtCmSucessoCr' ? (
    <Col md="filtroAtCmSucessoCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroAtCmSucessoCr" type="string" className="form-control" name="filtroAtCmSucessoCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerMediaPadAbertoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verMediaPadAbertoCr' ? (
    <Col md="verMediaPadAbertoCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verMediaPadAbertoCr" type="string" className="form-control" name="verMediaPadAbertoCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroMediaPadAbertoCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroMediaPadAbertoCr' ? (
    <Col md="filtroMediaPadAbertoCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroMediaPadAbertoCrLabel" for="usuario-painel-gerencial-filtroMediaPadAbertoCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroMediaPadAbertoCr">Filtro Media Pad Aberto Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerAtIntercorrenciaCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verAtIntercorrenciaCr' ? (
        ...
        <Row>
          <Col md="3">
            <Label className="mt-2" id="verAtIntercorrenciaCrLabel" for="usuario-painel-gerencial-verAtIntercorrenciaCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.verAtIntercorrenciaCr">Ver At Intercorrencia Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const FiltroAtIntercorrenciaCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroAtIntercorrenciaCr' ? (
    <Col md="filtroAtIntercorrenciaCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroAtIntercorrenciaCrLabel" for="usuario-painel-gerencial-filtroAtIntercorrenciaCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroAtIntercorrenciaCr">Filtro At Intercorrencia Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerTempoMedioAtCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verTempoMedioAtCr' ? (
    <Col md="verTempoMedioAtCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verTempoMedioAtCr" type="string" className="form-control" name="verTempoMedioAtCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroTempoMedioAtCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroTempoMedioAtCr' ? (
        ...
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroTempoMedioAtCrLabel" for="usuario-painel-gerencial-filtroTempoMedioAtCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroTempoMedioAtCr">Filtro Tempo Medio At Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const VerMediaPtaCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verMediaPtaCr' ? (
    <Col md="verMediaPtaCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-verMediaPtaCr" type="string" className="form-control" name="verMediaPtaCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const FiltroMediaPtaCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroMediaPtaCr' ? (
    <Col md="filtroMediaPtaCr">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="usuario-painel-gerencial-filtroMediaPtaCr" type="string" className="form-control" name="filtroMediaPtaCr" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const VerIndicadorUsoAppCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'verIndicadorUsoAppCr' ? (
        ...
        <Row>
          <Col md="3">
            <Label className="mt-2" id="verIndicadorUsoAppCrLabel" for="usuario-painel-gerencial-verIndicadorUsoAppCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.verIndicadorUsoAppCr">Ver Indicador Uso App Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
...
const FiltroIndicadorUsoAppCrComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'filtroIndicadorUsoAppCr' ? (
    <Col md="filtroIndicadorUsoAppCr">
      <AvGroup>
        <Row>
          <Col md="3">
            <Label className="mt-2" id="filtroIndicadorUsoAppCrLabel" for="usuario-painel-gerencial-filtroIndicadorUsoAppCr">
              <Translate contentKey="generadorApp.usuarioPainelGerencial.filtroIndicadorUsoAppCr">Filtro Indicador Uso App Cr</Translate>
            </Label>
          </Col>
          <Col md="9">
            <AvField
