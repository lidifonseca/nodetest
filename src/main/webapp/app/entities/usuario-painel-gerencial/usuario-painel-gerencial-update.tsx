...
export class UsuarioPainelGerencialUpdate extends React.Component<IUsuarioPainelGerencialUpdateProps, IUsuarioPainelGerencialUpdateState> {
  ...
  getFiltersURL = (offset = null) => {
    ...
    return (
      ...
      (fieldsBase['verCronicos'] ? '&verCronicos=' + fieldsBase['verCronicos'] : '') +
      (fieldsBase['verPacientesAtivosCr'] ? '&verPacientesAtivosCr=' + fieldsBase['verPacientesAtivosCr'] : '') +
      (fieldsBase['filtroPacientesAtivosCr'] ? '&filtroPacientesAtivosCr=' + fieldsBase['filtroPacientesAtivosCr'] : '') +
      (fieldsBase['verNumHospCr'] ? '&verNumHospCr=' + fieldsBase['verNumHospCr'] : '') +
      (fieldsBase['filtroNumHospCr'] ? '&filtroNumHospCr=' + fieldsBase['filtroNumHospCr'] : '') +
      (fieldsBase['verNumDesospCr'] ? '&verNumDesospCr=' + fieldsBase['verNumDesospCr'] : '') +
      (fieldsBase['filtroNumDesospCr'] ? '&filtroNumDesospCr=' + fieldsBase['filtroNumDesospCr'] : '') +
      (fieldsBase['verNumPsCr'] ? '&verNumPsCr=' + fieldsBase['verNumPsCr'] : '') +
      (fieldsBase['filtroNumPsCr'] ? '&filtroNumPsCr=' + fieldsBase['filtroNumPsCr'] : '') +
      (fieldsBase['verNumObitoCr'] ? '&verNumObitoCr=' + fieldsBase['verNumObitoCr'] : '') +
      (fieldsBase['filtroNumObitoCr'] ? '&filtroNumObitoCr=' + fieldsBase['filtroNumObitoCr'] : '') +
      (fieldsBase['verIndCliEstaveisCr'] ? '&verIndCliEstaveisCr=' + fieldsBase['verIndCliEstaveisCr'] : '') +
      (fieldsBase['filtroIndCliEstaveisCr'] ? '&filtroIndCliEstaveisCr=' + fieldsBase['filtroIndCliEstaveisCr'] : '') +
      (fieldsBase['verNumConsMedInternasCr'] ? '&verNumConsMedInternasCr=' + fieldsBase['verNumConsMedInternasCr'] : '') +
      (fieldsBase['filtroNumConsMedInternasCr'] ? '&filtroNumConsMedInternasCr=' + fieldsBase['filtroNumConsMedInternasCr'] : '') +
      (fieldsBase['verNumConsMedExternasCr'] ? '&verNumConsMedExternasCr=' + fieldsBase['verNumConsMedExternasCr'] : '') +
      (fieldsBase['filtroNumConsMedExternasCr'] ? '&filtroNumConsMedExternasCr=' + fieldsBase['filtroNumConsMedExternasCr'] : '') +
      (fieldsBase['verNumLaboratorialCr'] ? '&verNumLaboratorialCr=' + fieldsBase['verNumLaboratorialCr'] : '') +
      (fieldsBase['filtroNumLaboratorialCr'] ? '&filtroNumLaboratorialCr=' + fieldsBase['filtroNumLaboratorialCr'] : '') +
      (fieldsBase['verNumImagemCr'] ? '&verNumImagemCr=' + fieldsBase['verNumImagemCr'] : '') +
      (fieldsBase['filtroNumImagemCr'] ? '&filtroNumImagemCr=' + fieldsBase['filtroNumImagemCr'] : '') +
      (fieldsBase['verNumOutrosCr'] ? '&verNumOutrosCr=' + fieldsBase['verNumOutrosCr'] : '') +
      (fieldsBase['filtroNumOutrosCr'] ? '&filtroNumOutrosCr=' + fieldsBase['filtroNumOutrosCr'] : '') +
      (fieldsBase['verNumAtCatCr'] ? '&verNumAtCatCr=' + fieldsBase['verNumAtCatCr'] : '') +
      (fieldsBase['filtroNumAtCatCr'] ? '&filtroNumAtCatCr=' + fieldsBase['filtroNumAtCatCr'] : '') +
      (fieldsBase['verNumCatCompCr'] ? '&verNumCatCompCr=' + fieldsBase['verNumCatCompCr'] : '') +
      (fieldsBase['filtroNumCatCompCr'] ? '&filtroNumCatCompCr=' + fieldsBase['filtroNumCatCompCr'] : '') +
      (fieldsBase['verAtCmSucessoCr'] ? '&verAtCmSucessoCr=' + fieldsBase['verAtCmSucessoCr'] : '') +
      (fieldsBase['filtroAtCmSucessoCr'] ? '&filtroAtCmSucessoCr=' + fieldsBase['filtroAtCmSucessoCr'] : '') +
      (fieldsBase['verMediaPadAbertoCr'] ? '&verMediaPadAbertoCr=' + fieldsBase['verMediaPadAbertoCr'] : '') +
      (fieldsBase['filtroMediaPadAbertoCr'] ? '&filtroMediaPadAbertoCr=' + fieldsBase['filtroMediaPadAbertoCr'] : '') +
      (fieldsBase['verAtIntercorrenciaCr'] ? '&verAtIntercorrenciaCr=' + fieldsBase['verAtIntercorrenciaCr'] : '') +
      (fieldsBase['filtroAtIntercorrenciaCr'] ? '&filtroAtIntercorrenciaCr=' + fieldsBase['filtroAtIntercorrenciaCr'] : '') +
      (fieldsBase['verTempoMedioAtCr'] ? '&verTempoMedioAtCr=' + fieldsBase['verTempoMedioAtCr'] : '') +
      (fieldsBase['filtroTempoMedioAtCr'] ? '&filtroTempoMedioAtCr=' + fieldsBase['filtroTempoMedioAtCr'] : '') +
      (fieldsBase['verMediaPtaCr'] ? '&verMediaPtaCr=' + fieldsBase['verMediaPtaCr'] : '') +
      (fieldsBase['filtroMediaPtaCr'] ? '&filtroMediaPtaCr=' + fieldsBase['filtroMediaPtaCr'] : '') +
      (fieldsBase['verIndicadorUsoAppCr'] ? '&verIndicadorUsoAppCr=' + fieldsBase['verIndicadorUsoAppCr'] : '') +
      (fieldsBase['filtroIndicadorUsoAppCr'] ? '&filtroIndicadorUsoAppCr=' + fieldsBase['filtroIndicadorUsoAppCr'] : '') +
      ''
    );
  };
