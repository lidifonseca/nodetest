...
import PacienteCaracteristicaAtualRelatorioCSV from './relatorio/paciente-caracteristica-atual.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacienteCaracteristicaAtualRelatorioCSV} />
