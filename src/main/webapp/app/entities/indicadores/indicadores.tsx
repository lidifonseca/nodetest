...
export class Indicadores extends React.Component<IIndicadoresProps, IIndicadoresState> {
  ...
  constructor(props: IIndicadoresProps) {
    super(props);
    this.state = {
  ...
  render() {
    const { indicadoresList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="page-heading">
          <span className="page-header">Indicadores</span>
          <Button id="togglerFilterIndicadores" className="btn btn-primary float-right jh-create-entity">
            <Translate contentKey="generadorApp.indicadores.home.btn_filter_open">Filters</Translate>
            &nbsp;
        ...
        <Panel>
          <PanelBody>
            <div className="table-responsive">
              <UncontrolledCollapse toggler="#togglerFilterIndicadores">
                <CardBody>
                  <AvForm ref={el => (this.myFormRef = el)} id="form-filter" onSubmit={this.filterEntity}>
                    ...
                    <div className="row mb-2 mr-4 justify-content-end">
                      <Button className="btn btn-success" type="submit">
                        ...
                        &nbsp;
                        <Translate contentKey="generadorApp.indicadores.home.btn_filter">Filter</Translate>
                      </Button>
                      &nbsp;
                      <div className="btn btn-secondary hand" onClick={this.cancelCourse}>
                        <FontAwesomeIcon icon="trash-alt" />
                        &nbsp;
                        <Translate contentKey="generadorApp.indicadores.home.btn_filter_clean">Clean</Translate>
                      </div>
                    </div>
                  </AvForm>
                </CardBody>
              ...
              {indicadoresList && indicadoresList.length > 0 ? (
                <Table responsive aria-describedby="indicadores-heading" className={'table-hover table-striped mt-4'}>
                  ...
                  <tbody>
                    <tr></tr>
                    {indicadoresList.map((indicadores, i) => (
                      <tr key={`entity-${i}`}>
                        <td>
                          <Button tag={Link} to={`${match.url}/${indicadores.id}`} color="link" size="sm">
                            {indicadores.id}
                          </Button>
                        </td>
                ...
                <div className="alert alert-warning">
                  <Translate contentKey="generadorApp.indicadores.home.notFound">No Indicadores found</Translate>
                </div>
              )}
            </div>
          </PanelBody>
          <PanelFooter>
            <div className={indicadoresList && indicadoresList.length > 0 ? '' : 'd-none'}>
...
const mapStateToProps = ({ indicadores, ...storeState }: IRootState) => ({
  indicadoresList: indicadores.entities,
  totalItems: indicadores.totalItems
});
