...
import { getIndicadoresState, IIndicadoresBaseState, getEntitiesExport } from '../indicadores.reducer';
...
export class Indicadores extends React.Component<IIndicadoresProps, IIndicadoresState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(titulo, indicadoresValores, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
