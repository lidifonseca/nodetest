    ...
    return (
      <div>
        <ol className="breadcrumb float-xl-right">
          ...
          <li className="breadcrumb-item active">Indicadores edit</li>
        </ol>
            ...
            <PanelHeader>
              <h2 id="page-heading">
                <span className="page-header ml-3">
                  <Translate contentKey="generadorApp.indicadores.home.createOrEditLabel">Create or edit a Indicadores</Translate>
                </span>
...
const mapStateToProps = (storeState: IRootState) => ({
  indicadoresEntity: storeState.indicadores.entity,
  loading: storeState.indicadores.loading,
  updating: storeState.indicadores.updating,
  updateSuccess: storeState.indicadores.updateSuccess
});
