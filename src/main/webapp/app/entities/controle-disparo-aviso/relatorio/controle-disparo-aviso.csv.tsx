...
import { getControleDisparoAvisoState, IControleDisparoAvisoBaseState, getEntitiesExport } from '../controle-disparo-aviso.reducer';
...
export class ControleDisparoAviso extends React.Component<IControleDisparoAvisoProps, IControleDisparoAvisoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idAtendimento, qtdDisparo, avisopush, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
