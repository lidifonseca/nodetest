                ...
                <Col md="8">
                  {loading ? (
                    ...
                    <div>
                      ...
                      <Row>
                        <IdCidadeComponentUpdate baseFilters />

                        <IdTempoExperienciaComponentUpdate baseFilters />

                        <IdBancoComponentUpdate baseFilters />
                        ...
                        <NomeEmpresaComponentUpdate baseFilters />
                        ...
                        <AtendeCriancaComponentUpdate baseFilters />

                        <AtendeIdosoComponentUpdate baseFilters />

                        <AgComponentUpdate baseFilters />

                        <ContaComponentUpdate baseFilters />

                        <TipoContaComponentUpdate baseFilters />

                        <OrigemCadastroComponentUpdate baseFilters />

                        <ObsComponentUpdate baseFilters />

                        <ChavePrivadaComponentUpdate baseFilters />

                        <AtivoComponentUpdate baseFilters />

                        <SenhaOriginalComponentUpdate baseFilters />

                        <DataSenhaComponentUpdate baseFilters />
...
const IdCidadeComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'idCidade' ? (
    <Col md="idCidade">
      <AvGroup>
        <Row>
          <Col md="3">
...
const IdTempoExperienciaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'idTempoExperiencia' ? (
    <Col md="idTempoExperiencia">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="profissional-idTempoExperiencia" type="string" className="form-control" name="idTempoExperiencia" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
...
const IdBancoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'idBanco' ? (
    <Col md="idBanco">
      <AvGroup>
        <Row>
          <Col md="3">
...
const NomeEmpresaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'nomeEmpresa' ? (
    <Col md="nomeEmpresa">
      <AvGroup>
        <Row>
          <Col md="3">
...
const AtendeCriancaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'atendeCrianca' ? (
...
const AtendeIdosoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'atendeIdoso' ? (
    <Col md="atendeIdoso">
      <AvGroup>
        <Row>
          <Col md="3">
...
const AgComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'ag' ? (
    <Col md="ag">
      <AvGroup>
        <Row>
          <Col md="3">
...
const ContaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'conta' ? (
    <Col md="conta">
      <AvGroup>
        <Row>
          <Col md="3">
...
const TipoContaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'tipoConta' ? (
    <Col md="tipoConta">
      <AvGroup>
        <Row>
          <Col md="3">
...
const OrigemCadastroComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'origemCadastro' ? (
...
const ChavePrivadaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'chavePrivada' ? (
    <Col md="chavePrivada">
      <AvGroup>
        <Row>
          <Col md="3">
...
const SenhaOriginalComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'senhaOriginal' ? (
...
const DataSenhaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'dataSenha' ? (
    <Col md="dataSenha">
      <AvGroup>
        <Row>
          <Col md="3">
...
const PreferenciaAtendimentoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'preferenciaAtendimento' ? (
    <Col md="preferenciaAtendimento">
      <AvGroup>
        <Row>
          ...
          <Col md="9">
            <AvField id="profissional-preferenciaAtendimento" type="string" className="form-control" name="preferenciaAtendimento" />
          </Col>
        </Row>
      </AvGroup>
    </Col>
