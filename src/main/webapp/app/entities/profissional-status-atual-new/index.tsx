...
import ProfissionalStatusAtualNewRelatorioCSV from './relatorio/profissional-status-atual-new.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalStatusAtualNewRelatorioCSV} />
