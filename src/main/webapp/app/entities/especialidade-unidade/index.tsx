...
import EspecialidadeUnidadeRelatorioCSV from './relatorio/especialidade-unidade.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={EspecialidadeUnidadeRelatorioCSV} />
