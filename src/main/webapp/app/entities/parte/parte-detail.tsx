...
export const ParteDetail = (props: IParteDetailProps) => {
  useEffect(() => {
    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="participante">Participante</span>
          </dt>
          <dd>{parteEntity.participante}</dd>
          <dt>
            <span id="advogados">Advogados</span>
          </dt>
...
export default connect(mapStateToProps, mapDispatchToProps)(ParteDetail);
