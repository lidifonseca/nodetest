...
export const Parte = (props: IParteProps) => {
  ...
  const { parteList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="parte-heading">
        Partes
      ...
      <div className="table-responsive">
        {parteList && parteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('participante')}>
                  Participante <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('advogados')}>
                  Advogados <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${parte.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${parte.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          !loading && <div className="alert alert-warning">No Partes found</div>
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Parte);
