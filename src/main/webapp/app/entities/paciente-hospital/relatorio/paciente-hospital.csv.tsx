...
import { getPacienteHospitalState, IPacienteHospitalBaseState, getEntitiesExport } from '../paciente-hospital.reducer';
...
export class PacienteHospital extends React.Component<IPacienteHospitalProps, IPacienteHospitalState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(servico, styleLabel, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
