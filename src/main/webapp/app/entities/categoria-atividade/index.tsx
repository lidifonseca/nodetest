...
import CategoriaAtividadeRelatorioCSV from './relatorio/categoria-atividade.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={CategoriaAtividadeRelatorioCSV} />
