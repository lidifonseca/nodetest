        ...
        >
          <h2 id="page-heading">
            <span className="page-header ml-3">
              <Translate contentKey="generadorApp.descPta.home.createOrEditLabel">Create or edit a DescPta</Translate>
            </span>
          ...
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item active">Desc Ptas edit</li>
          </ol>
...
const mapStateToProps = (storeState: IRootState) => ({
  descPtaEntity: storeState.descPta.entity,
  loading: storeState.descPta.loading,
  updating: storeState.descPta.updating,
  updateSuccess: storeState.descPta.updateSuccess
});
