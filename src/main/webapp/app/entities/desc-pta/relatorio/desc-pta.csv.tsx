...
import { getDescPtaState, IDescPtaBaseState, getEntitiesExport } from '../desc-pta.reducer';
...
export class DescPta extends React.Component<IDescPtaProps, IDescPtaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nome, resultadoEsperado, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
