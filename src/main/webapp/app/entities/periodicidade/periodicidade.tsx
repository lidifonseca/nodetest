...
export class Periodicidade extends React.Component<IPeriodicidadeProps, IPeriodicidadeState> {
  ...
  render() {
    const { periodicidadeList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="page-heading">
          <span className="page-header">Periodicidades</span>
          <Button id="togglerFilterPeriodicidade" className="btn btn-primary float-right jh-create-entity">
            <Translate contentKey="generadorApp.periodicidade.home.btn_filter_open">Filters</Translate>
            &nbsp;
        ...
        <Panel>
          <PanelBody>
            <div className="table-responsive">
              <UncontrolledCollapse toggler="#togglerFilterPeriodicidade">
                <CardBody>
                  <AvForm ref={el => (this.myFormRef = el)} id="form-filter" onSubmit={this.filterEntity}>
                    ...
                    <div className="row mb-2 mr-4 justify-content-end">
                      <Button className="btn btn-success" type="submit">
                        ...
                        &nbsp;
                        <Translate contentKey="generadorApp.periodicidade.home.btn_filter">Filter</Translate>
                      </Button>
                      &nbsp;
                      <div className="btn btn-secondary hand" onClick={this.cancelCourse}>
                        <FontAwesomeIcon icon="trash-alt" />
                        &nbsp;
                        <Translate contentKey="generadorApp.periodicidade.home.btn_filter_clean">Clean</Translate>
                      </div>
                    </div>
                  </AvForm>
                </CardBody>
              ...
              {periodicidadeList && periodicidadeList.length > 0 ? (
                <Table responsive aria-describedby="periodicidade-heading" className={'table-hover table-striped mt-4'}>
                  ...
                  <tbody>
                    <tr></tr>
                    {periodicidadeList.map((periodicidade, i) => (
                      <tr key={`entity-${i}`}>
                        <td>
                          <Button tag={Link} to={`${match.url}/${periodicidade.id}`} color="link" size="sm">
                            {periodicidade.id}
                          </Button>
                        </td>
                        ...
                        {this.state.baseFilters !== 'ativo' ? <td>{periodicidade.ativo ? 'true' : 'false'}</td> : null}
                ...
                <div className="alert alert-warning">
                  <Translate contentKey="generadorApp.periodicidade.home.notFound">No Periodicidades found</Translate>
                </div>
              )}
            </div>
          </PanelBody>
          <PanelFooter>
            <div className={periodicidadeList && periodicidadeList.length > 0 ? '' : 'd-none'}>
