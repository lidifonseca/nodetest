...
import { getEntity, updateEntity, createEntity, reset } from './pad-item-alerta.reducer';
...
export class PadItemAlertaUpdate extends React.Component<IPadItemAlertaUpdateProps, IPadItemAlertaUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/pad-item-alerta');
  };
          ...
          <Panel>
            <PanelHeader>
              <h2 id="page-heading">
                ...
                <Button tag={Link} id="cancel-save" to="/pad-item-alerta" replace color="info" className="float-right jh-create-entity">
