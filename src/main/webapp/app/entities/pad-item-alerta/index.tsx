...
import PadItemAlertaRelatorioCSV from './relatorio/pad-item-alerta.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PadItemAlertaRelatorioCSV} />
