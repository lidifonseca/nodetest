...
import { getStatusPadItemMetaState, IStatusPadItemMetaBaseState, getEntitiesExport } from '../status-pad-item-meta.reducer';
...
export class StatusPadItemMeta extends React.Component<IStatusPadItemMetaProps, IStatusPadItemMetaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(statusItemMeta, styleLabel, ordenacao, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
