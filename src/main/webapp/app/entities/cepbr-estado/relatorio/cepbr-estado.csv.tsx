...
import { getCepbrEstadoState, ICepbrEstadoBaseState, getEntitiesExport } from '../cepbr-estado.reducer';
...
export class CepbrEstado extends React.Component<ICepbrEstadoProps, ICepbrEstadoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(uf, estado, codIbge, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
