...
import { getTipoMatMedState, ITipoMatMedBaseState, getEntities } from './tipo-mat-med.reducer';
...
export class TipoMatMed extends React.Component<ITipoMatMedProps, ITipoMatMedState> {
  ...
  constructor(props: ITipoMatMedProps) {
    ...
    this.state = {
      ...
      ...getTipoMatMedState(this.props.location)
    };
  }
                      ...
                      <tr key={`entity-${i}`}>
                        ...
                        <td className="text-right">
                          <div className="btn-group flex-btn-group-container">
                            <Button tag={Link} to={`${match.url}/${tipoMatMed.id}?${this.getFiltersURL()}`} color="info" size="sm">
                              <FontAwesomeIcon icon="eye" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.view">View</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${tipoMatMed.id}/edit?${this.getFiltersURL()}`} color="primary" size="sm">
                              <FontAwesomeIcon icon="pencil-alt" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.edit">Edit</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${tipoMatMed.id}/delete?${this.getFiltersURL()}`} color="danger" size="sm">
