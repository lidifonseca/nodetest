...
export const getEntities: ICrudGetAllActionPadItemCepRecusado<IPadItemCepRecusado> = (cep, dataPost, idPadItem, page, size, sort) => {
  ...
  return {
    ...
    payload: axios.get<IPadItemCepRecusado>(
