    ...
    return (
      <div>
        <h2 id="cliente-heading">
          <Translate contentKey="tjscrapperApp.cliente.home.title">Clientes</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="tjscrapperApp.cliente.home.createLabel">Create a new Cliente</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {clienteList && clienteList.length > 0 ? (
            <Table responsive aria-describedby="cliente-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('ativo')}>
                    <Translate contentKey="tjscrapperApp.cliente.ativo">Ativo</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="tjscrapperApp.cliente.user">User</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {clienteList.map((cliente, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>{cliente.ativo ? 'true' : 'false'}</td>
                    <td>{cliente.userId ? cliente.userId : ''}</td>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="tjscrapperApp.cliente.home.notFound">No Clientes found</Translate>
            </div>
          )}
        </div>
