...
import PacientePedidoRelatorioCSV from './relatorio/paciente-pedido.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacientePedidoRelatorioCSV} />
