...
import PacienteDiagnosticoRelatorioCSV from './relatorio/paciente-diagnostico.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacienteDiagnosticoRelatorioCSV} />
