...
import ProfissionalAreaAtuacaoNewRelatorioCSV from './relatorio/profissional-area-atuacao-new.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalAreaAtuacaoNewRelatorioCSV} />
