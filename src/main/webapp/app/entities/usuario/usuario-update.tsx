...
export class UsuarioUpdate extends React.Component<IUsuarioUpdateProps, IUsuarioUpdateState> {
  ...
  getFiltersURL = (offset = null) => {
    ...
    return (
      ...
      (fieldsBase['telefone'] ? '&telefone=' + fieldsBase['telefone'] : '') +
      (fieldsBase['celular'] ? '&celular=' + fieldsBase['celular'] : '') +
      ...
      (fieldsBase['verAtendimento'] ? '&verAtendimento=' + fieldsBase['verAtendimento'] : '') +
      (fieldsBase['cadAtendimento'] ? '&cadAtendimento=' + fieldsBase['cadAtendimento'] : '') +
      (fieldsBase['ediAtendimento'] ? '&ediAtendimento=' + fieldsBase['ediAtendimento'] : '') +
      (fieldsBase['baixaManualAtendimento'] ? '&baixaManualAtendimento=' + fieldsBase['baixaManualAtendimento'] : '') +
      (fieldsBase['delAtendimento'] ? '&delAtendimento=' + fieldsBase['delAtendimento'] : '') +
      (fieldsBase['relAtendimento'] ? '&relAtendimento=' + fieldsBase['relAtendimento'] : '') +
      (fieldsBase['verPad'] ? '&verPad=' + fieldsBase['verPad'] : '') +
      (fieldsBase['cadPad'] ? '&cadPad=' + fieldsBase['cadPad'] : '') +
      (fieldsBase['ediPad'] ? '&ediPad=' + fieldsBase['ediPad'] : '') +
      (fieldsBase['delPad'] ? '&delPad=' + fieldsBase['delPad'] : '') +
      (fieldsBase['relPad'] ? '&relPad=' + fieldsBase['relPad'] : '') +
      (fieldsBase['verDiario'] ? '&verDiario=' + fieldsBase['verDiario'] : '') +
      (fieldsBase['cadDiario'] ? '&cadDiario=' + fieldsBase['cadDiario'] : '') +
      (fieldsBase['ediDiario'] ? '&ediDiario=' + fieldsBase['ediDiario'] : '') +
      (fieldsBase['delDiario'] ? '&delDiario=' + fieldsBase['delDiario'] : '') +
      (fieldsBase['relDiario'] ? '&relDiario=' + fieldsBase['relDiario'] : '') +
      (fieldsBase['verCategoria'] ? '&verCategoria=' + fieldsBase['verCategoria'] : '') +
      (fieldsBase['cadCategoria'] ? '&cadCategoria=' + fieldsBase['cadCategoria'] : '') +
      (fieldsBase['ediCategoria'] ? '&ediCategoria=' + fieldsBase['ediCategoria'] : '') +
      (fieldsBase['delCategoria'] ? '&delCategoria=' + fieldsBase['delCategoria'] : '') +
      (fieldsBase['verEspecialidade'] ? '&verEspecialidade=' + fieldsBase['verEspecialidade'] : '') +
      (fieldsBase['cadEspecialidade'] ? '&cadEspecialidade=' + fieldsBase['cadEspecialidade'] : '') +
      (fieldsBase['ediEspecialidade'] ? '&ediEspecialidade=' + fieldsBase['ediEspecialidade'] : '') +
      (fieldsBase['delEspecialidade'] ? '&delEspecialidade=' + fieldsBase['delEspecialidade'] : '') +
      (fieldsBase['relEspecialidade'] ? '&relEspecialidade=' + fieldsBase['relEspecialidade'] : '') +
      (fieldsBase['verEspecialidadeValor'] ? '&verEspecialidadeValor=' + fieldsBase['verEspecialidadeValor'] : '') +
      (fieldsBase['cadEspecialidadeValor'] ? '&cadEspecialidadeValor=' + fieldsBase['cadEspecialidadeValor'] : '') +
      (fieldsBase['ediEspecialidadeValor'] ? '&ediEspecialidadeValor=' + fieldsBase['ediEspecialidadeValor'] : '') +
      (fieldsBase['delEspecialidadeValor'] ? '&delEspecialidadeValor=' + fieldsBase['delEspecialidadeValor'] : '') +
      (fieldsBase['relEspecialidadeValor'] ? '&relEspecialidadeValor=' + fieldsBase['relEspecialidadeValor'] : '') +
      (fieldsBase['verOperadora'] ? '&verOperadora=' + fieldsBase['verOperadora'] : '') +
      (fieldsBase['cadOperadora'] ? '&cadOperadora=' + fieldsBase['cadOperadora'] : '') +
      (fieldsBase['ediOperadora'] ? '&ediOperadora=' + fieldsBase['ediOperadora'] : '') +
      (fieldsBase['delOperadora'] ? '&delOperadora=' + fieldsBase['delOperadora'] : '') +
      (fieldsBase['verPaciente'] ? '&verPaciente=' + fieldsBase['verPaciente'] : '') +
      (fieldsBase['cadPaciente'] ? '&cadPaciente=' + fieldsBase['cadPaciente'] : '') +
      (fieldsBase['ediPaciente'] ? '&ediPaciente=' + fieldsBase['ediPaciente'] : '') +
      (fieldsBase['delPaciente'] ? '&delPaciente=' + fieldsBase['delPaciente'] : '') +
      (fieldsBase['relPaciente'] ? '&relPaciente=' + fieldsBase['relPaciente'] : '') +
      (fieldsBase['verProfissional'] ? '&verProfissional=' + fieldsBase['verProfissional'] : '') +
      (fieldsBase['cadProfissional'] ? '&cadProfissional=' + fieldsBase['cadProfissional'] : '') +
      (fieldsBase['ediProfissional'] ? '&ediProfissional=' + fieldsBase['ediProfissional'] : '') +
      (fieldsBase['delProfissional'] ? '&delProfissional=' + fieldsBase['delProfissional'] : '') +
      (fieldsBase['ativProfissional'] ? '&ativProfissional=' + fieldsBase['ativProfissional'] : '') +
      (fieldsBase['relProfissional'] ? '&relProfissional=' + fieldsBase['relProfissional'] : '') +
      (fieldsBase['verPush'] ? '&verPush=' + fieldsBase['verPush'] : '') +
      (fieldsBase['cadPushPaciente'] ? '&cadPushPaciente=' + fieldsBase['cadPushPaciente'] : '') +
      (fieldsBase['cadPushProfissional'] ? '&cadPushProfissional=' + fieldsBase['cadPushProfissional'] : '') +
      (fieldsBase['verTermoPaciente'] ? '&verTermoPaciente=' + fieldsBase['verTermoPaciente'] : '') +
      (fieldsBase['ediTermoPaciente'] ? '&ediTermoPaciente=' + fieldsBase['ediTermoPaciente'] : '') +
      (fieldsBase['verTermoProfissional'] ? '&verTermoProfissional=' + fieldsBase['verTermoProfissional'] : '') +
      (fieldsBase['ediTermoProfissional'] ? '&ediTermoProfissional=' + fieldsBase['ediTermoProfissional'] : '') +
      (fieldsBase['verOutros'] ? '&verOutros=' + fieldsBase['verOutros'] : '') +
      (fieldsBase['cadOutros'] ? '&cadOutros=' + fieldsBase['cadOutros'] : '') +
      (fieldsBase['ediOutros'] ? '&ediOutros=' + fieldsBase['ediOutros'] : '') +
      (fieldsBase['delOutros'] ? '&delOutros=' + fieldsBase['delOutros'] : '') +
      (fieldsBase['relOutros'] ? '&relOutros=' + fieldsBase['relOutros'] : '') +
      (fieldsBase['verUnidadeEasy'] ? '&verUnidadeEasy=' + fieldsBase['verUnidadeEasy'] : '') +
      (fieldsBase['cadUnidadeEasy'] ? '&cadUnidadeEasy=' + fieldsBase['cadUnidadeEasy'] : '') +
      (fieldsBase['ediUnidadeEasy'] ? '&ediUnidadeEasy=' + fieldsBase['ediUnidadeEasy'] : '') +
      (fieldsBase['delUnidadeEasy'] ? '&delUnidadeEasy=' + fieldsBase['delUnidadeEasy'] : '') +
      (fieldsBase['verUsuario'] ? '&verUsuario=' + fieldsBase['verUsuario'] : '') +
      (fieldsBase['cadUsuario'] ? '&cadUsuario=' + fieldsBase['cadUsuario'] : '') +
      (fieldsBase['ediUsuario'] ? '&ediUsuario=' + fieldsBase['ediUsuario'] : '') +
      (fieldsBase['delUsuario'] ? '&delUsuario=' + fieldsBase['delUsuario'] : '') +
      (fieldsBase['verPtaResultado'] ? '&verPtaResultado=' + fieldsBase['verPtaResultado'] : '') +
      (fieldsBase['cadPtaResultado'] ? '&cadPtaResultado=' + fieldsBase['cadPtaResultado'] : '') +
      (fieldsBase['delPtaResultado'] ? '&delPtaResultado=' + fieldsBase['delPtaResultado'] : '') +
      (fieldsBase['verPtaAtividade'] ? '&verPtaAtividade=' + fieldsBase['verPtaAtividade'] : '') +
      (fieldsBase['cadPtaAtividade'] ? '&cadPtaAtividade=' + fieldsBase['cadPtaAtividade'] : '') +
      (fieldsBase['delPtaAtividade'] ? '&delPtaAtividade=' + fieldsBase['delPtaAtividade'] : '') +
      (fieldsBase['permissaoUsuario'] ? '&permissaoUsuario=' + fieldsBase['permissaoUsuario'] : '') +
      (fieldsBase['verProntuario'] ? '&verProntuario=' + fieldsBase['verProntuario'] : '') +
      (fieldsBase['cadProntuario'] ? '&cadProntuario=' + fieldsBase['cadProntuario'] : '') +
      (fieldsBase['ediProntuario'] ? '&ediProntuario=' + fieldsBase['ediProntuario'] : '') +
      (fieldsBase['delProntuario'] ? '&delProntuario=' + fieldsBase['delProntuario'] : '') +
      (fieldsBase['delProntuarioFoto'] ? '&delProntuarioFoto=' + fieldsBase['delProntuarioFoto'] : '') +
      (fieldsBase['valoresFinanceiro'] ? '&valoresFinanceiro=' + fieldsBase['valoresFinanceiro'] : '') +
      (fieldsBase['autorizacaoValorFinanceiro'] ? '&autorizacaoValorFinanceiro=' + fieldsBase['autorizacaoValorFinanceiro'] : '') +
      (fieldsBase['confirmarPagamentoFinanceiro'] ? '&confirmarPagamentoFinanceiro=' + fieldsBase['confirmarPagamentoFinanceiro'] : '') +
      (fieldsBase['gerenciarSorteios'] ? '&gerenciarSorteios=' + fieldsBase['gerenciarSorteios'] : '') +
      (fieldsBase['envioRecusa'] ? '&envioRecusa=' + fieldsBase['envioRecusa'] : '') +
      (fieldsBase['envioIntercorrencia'] ? '&envioIntercorrencia=' + fieldsBase['envioIntercorrencia'] : '') +
      (fieldsBase['envioCancelamento'] ? '&envioCancelamento=' + fieldsBase['envioCancelamento'] : '') +
      (fieldsBase['envioAvaliacao'] ? '&envioAvaliacao=' + fieldsBase['envioAvaliacao'] : '') +
      (fieldsBase['envioPedido'] ? '&envioPedido=' + fieldsBase['envioPedido'] : '') +
      (fieldsBase['alertaAtendimento'] ? '&alertaAtendimento=' + fieldsBase['alertaAtendimento'] : '') +
      (fieldsBase['ativo'] ? '&ativo=' + fieldsBase['ativo'] : '') +
      (fieldsBase['envioGlosado'] ? '&envioGlosado=' + fieldsBase['envioGlosado'] : '') +
      (fieldsBase['emergencia'] ? '&emergencia=' + fieldsBase['emergencia'] : '') +
      (fieldsBase['token'] ? '&token=' + fieldsBase['token'] : '') +
      (fieldsBase['editAtendimento'] ? '&editAtendimento=' + fieldsBase['editAtendimento'] : '') +
      (fieldsBase['ouvirLigacao'] ? '&ouvirLigacao=' + fieldsBase['ouvirLigacao'] : '') +
      (fieldsBase['verPainelIndicadores'] ? '&verPainelIndicadores=' + fieldsBase['verPainelIndicadores'] : '') +
      (fieldsBase['prorrogarPad'] ? '&prorrogarPad=' + fieldsBase['prorrogarPad'] : '') +
      (fieldsBase['cancelarAtendMassa'] ? '&cancelarAtendMassa=' + fieldsBase['cancelarAtendMassa'] : '') +
      (fieldsBase['cadMatMed'] ? '&cadMatMed=' + fieldsBase['cadMatMed'] : '') +
      (fieldsBase['ediMatMed'] ? '&ediMatMed=' + fieldsBase['ediMatMed'] : '') +
      (fieldsBase['delMatMed'] ? '&delMatMed=' + fieldsBase['delMatMed'] : '') +
      (fieldsBase['verColPta'] ? '&verColPta=' + fieldsBase['verColPta'] : '') +
      (fieldsBase['verColFoto'] ? '&verColFoto=' + fieldsBase['verColFoto'] : '') +
      (fieldsBase['verColLc'] ? '&verColLc=' + fieldsBase['verColLc'] : '') +
      (fieldsBase['verAtendCancelado'] ? '&verAtendCancelado=' + fieldsBase['verAtendCancelado'] : '') +
      (fieldsBase['verAtendAgConfirmacao'] ? '&verAtendAgConfirmacao=' + fieldsBase['verAtendAgConfirmacao'] : '') +
      (fieldsBase['ediGeoLocalizacaoAtendimento'] ? '&ediGeoLocalizacaoAtendimento=' + fieldsBase['ediGeoLocalizacaoAtendimento'] : '') +
      (fieldsBase['copiarEvolucao'] ? '&copiarEvolucao=' + fieldsBase['copiarEvolucao'] : '') +
      (fieldsBase['copiarNomeProf'] ? '&copiarNomeProf=' + fieldsBase['copiarNomeProf'] : '') +
      (fieldsBase['copiarRegistroProf'] ? '&copiarRegistroProf=' + fieldsBase['copiarRegistroProf'] : '') +
      (fieldsBase['idAreaAtuacao'] ? '&idAreaAtuacao=' + fieldsBase['idAreaAtuacao'] : '') +
      (fieldsBase['envioCidSemPta'] ? '&envioCidSemPta=' + fieldsBase['envioCidSemPta'] : '') +
      (fieldsBase['envioAnaliseResultadoEsperado'] ? '&envioAnaliseResultadoEsperado=' + fieldsBase['envioAnaliseResultadoEsperado'] : '') +
      (fieldsBase['envioDescumprimento'] ? '&envioDescumprimento=' + fieldsBase['envioDescumprimento'] : '') +
      (fieldsBase['envioMelhoraTempo'] ? '&envioMelhoraTempo=' + fieldsBase['envioMelhoraTempo'] : '') +
                  ...
                  {loading ? (
                    ...
                    <div>
                      ...
                      <Row>
                        ...
                        {baseFilters !== 'envioAnaliseResultadoEsperado' ? (
                            ...
                            <AvGroup>
                              <Row>
                                <Col md="3">
                                  <Label
                                    className="mt-2"
                                    id="envioAnaliseResultadoEsperadoLabel"
                                    for="usuario-envioAnaliseResultadoEsperado"
                                  >
                        ...
                        {baseFilters !== 'envioDescumprimento' ? (
                              ...
                              <Row>
                                <Col md="12">
                                  <Label className="mt-2" id="envioMelhoraTempoLabel" check>
                                    <AvInput
                                      id="usuario-envioMelhoraTempo"
                                      type="checkbox"
                                      className="form-control"
                                      name="envioMelhoraTempo"
                                    />
