...
import { getModulosPadState, IModulosPadBaseState, getEntitiesExport } from '../modulos-pad.reducer';
...
export class ModulosPad extends React.Component<IModulosPadProps, IModulosPadState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nomeModulo, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
