...
import { getMatMedState, IMatMedBaseState, getEntitiesExport } from '../mat-med.reducer';
...
export class MatMed extends React.Component<IMatMedProps, IMatMedState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(nome, idTipoMatMed, valor, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
