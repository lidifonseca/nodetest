...
import PushnotificationEnviosRelatorioCSV from './relatorio/pushnotification-envios.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PushnotificationEnviosRelatorioCSV} />
