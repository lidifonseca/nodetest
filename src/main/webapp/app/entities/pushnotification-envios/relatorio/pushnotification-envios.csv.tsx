...
import { getPushnotificationEnviosState, IPushnotificationEnviosBaseState, getEntitiesExport } from '../pushnotification-envios.reducer';
...
export class PushnotificationEnvios extends React.Component<IPushnotificationEnviosProps, IPushnotificationEnviosState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(referencia, ultimoEnvio, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
