...
import { getCepbrBairroState, ICepbrBairroBaseState, getEntitiesExport } from '../cepbr-bairro.reducer';
...
export class CepbrBairro extends React.Component<ICepbrBairroProps, ICepbrBairroState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idBairro, bairro, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
