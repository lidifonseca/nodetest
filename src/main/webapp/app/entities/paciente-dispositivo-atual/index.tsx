...
import PacienteDispositivoAtualRelatorioCSV from './relatorio/paciente-dispositivo-atual.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacienteDispositivoAtualRelatorioCSV} />
