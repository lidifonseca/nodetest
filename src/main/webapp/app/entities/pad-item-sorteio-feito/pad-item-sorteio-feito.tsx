...
export class PadItemSorteioFeito extends React.Component<IPadItemSorteioFeitoProps, IPadItemSorteioFeitoState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="page-heading">
          <span className="page-header">Pad Item Sorteio Feitos</span>
          <Button id="togglerFilterPadItemSorteioFeito" className="btn btn-primary float-right jh-create-entity">
            <Translate contentKey="generadorApp.padItemSorteioFeito.home.btn_filter_open">Filters</Translate>
            &nbsp;
                  ...
                  <AvForm ref={el => (this.myFormRef = el)} id="form-filter" onSubmit={this.filterEntity}>
                    <div className="row mt-1 ml-3 mr-3">
                      ...
                      {this.state.baseFilters !== 'padItem' ? (
                        <Col md="3">
                          <Row className="mr-1 mt-1">
                            <div style={{ width: '100%' }}>
                              <Label for="pad-item-sorteio-feito-padItem">
                    ...
                    <div className="row mb-2 mr-4 justify-content-end">
                      <Button className="btn btn-success" type="submit">
                        ...
                        &nbsp;
                        <Translate contentKey="generadorApp.padItemSorteioFeito.home.btn_filter">Filter</Translate>
                      </Button>
                      &nbsp;
                      <div className="btn btn-secondary hand" onClick={this.cancelCourse}>
                        <FontAwesomeIcon icon="trash-alt" />
                        &nbsp;
                        <Translate contentKey="generadorApp.padItemSorteioFeito.home.btn_filter_clean">Clean</Translate>
                      </div>
                    </div>
                  </AvForm>
                </CardBody>
                  ...
                  <tbody>
                    ...
                    {padItemSorteioFeitoList.map((padItemSorteioFeito, i) => (
                      <tr key={`entity-${i}`}>
                        ...
                        {this.state.baseFilters !== 'padItem' ? (
                          <td>
                            {padItemSorteioFeito.padItem ? (
                              <Link to={`pad-item/${padItemSorteioFeito.padItem.id}`}>{padItemSorteioFeito.padItem.id}</Link>
                            ) : (
                              ''
                            )}
                          </td>
