...
import PadItemSorteioFeitoRelatorioCSV from './relatorio/pad-item-sorteio-feito.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PadItemSorteioFeitoRelatorioCSV} />
