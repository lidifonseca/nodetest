...
import { getFilesPanicoState, IFilesPanicoBaseState, getEntitiesExport } from '../files-panico.reducer';
...
export class FilesPanico extends React.Component<IFilesPanicoProps, IFilesPanicoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPanico, idPaciente, tipo, imagem, criadoEm, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
