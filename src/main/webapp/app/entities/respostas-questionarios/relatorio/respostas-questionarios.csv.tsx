...
import { getRespostasQuestionariosState, IRespostasQuestionariosBaseState, getEntitiesExport } from '../respostas-questionarios.reducer';
...
export class RespostasQuestionarios extends React.Component<IRespostasQuestionariosProps, IRespostasQuestionariosState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(dataResposta, informacaoAdicional, questionarioId, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
