...
export const Peticao = (props: IPeticaoProps) => {
  ...
  const { peticaoList, match, loading, totalItems } = props;
  return (
    <div>
      ...
      <div className="table-responsive">
        {peticaoList && peticaoList.length > 0 ? (
                ...
                <tr key={`entity-${i}`}>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${peticao.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${peticao.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
          ...
          !loading && <div className="alert alert-warning">No Peticaos found</div>
        )}
      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(Peticao);
