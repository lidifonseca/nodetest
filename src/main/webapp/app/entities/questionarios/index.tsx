...
import QuestionariosRelatorioCSV from './relatorio/questionarios.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={QuestionariosRelatorioCSV} />
