...
import { getBancoState, IBancoBaseState, getEntitiesExport } from '../banco.reducer';
...
export class Banco extends React.Component<IBancoProps, IBancoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(codBanco, banco, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
