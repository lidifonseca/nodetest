  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="generadorApp.banco.delete.question">
          <Translate contentKey="generadorApp.banco.delete.question" interpolate={{ id: bancoEntity.id }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(BancoDeleteDialog);
