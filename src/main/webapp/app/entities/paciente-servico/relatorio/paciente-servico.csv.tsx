...
import { getPacienteServicoState, IPacienteServicoBaseState, getEntitiesExport } from '../paciente-servico.reducer';
...
export class PacienteServico extends React.Component<IPacienteServicoProps, IPacienteServicoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPaciente, servico, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
