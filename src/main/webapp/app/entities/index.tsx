...
const Routes = ({ match }) => (
  <div>
    <Switch>
      ...
      <ErrorBoundaryRoute path={`${match.url}phinxlog`} component={Phinxlog} />
      ...
      <ErrorBoundaryRoute path={`${match.url}categoria-contrato`} component={CategoriaContrato} />
      <ErrorBoundaryRoute path={`${match.url}categoria-unidade`} component={CategoriaUnidade} />
      ...
      <ErrorBoundaryRoute path={`${match.url}cid-x-pta-novo-pad-item-indicadores`} component={CidXPtaNovoPadItemIndicadores} />
