                      ...
                      <TabContent activeTab={this.state.activeTab}>
                        <TabPane tabId={0}>
                          ...
                          <Row>
                            ...
                            <CidadeComponentUpdate baseFilters cidades />

                            <UfComponentUpdate baseFilters />

                            <ProfissionalPrefComponentUpdate baseFilters profissionals />

                            <TipohospitalComponentUpdate baseFilters pacienteHospitals />

                            <LiminarComponentUpdate baseFilters />

                            <DetalhesComponentUpdate baseFilters />
                        ...
                        <TabPane tabId={1}>
                          ...
                          <Row>
                            <CepFamiliarComponentUpdate baseFilters />

                            <EnderecoFamiliarComponentUpdate baseFilters />

                            <NumeroFamiliarComponentUpdate baseFilters />

                            <ComplementoFamiliarComponentUpdate baseFilters />

                            <CidadeFamiliarComponentUpdate baseFilters cidades />

                            <BairroFamiliarComponentUpdate baseFilters />

                            <UfFamiliarComponentUpdate baseFilters />

                            <LatitudeFamiliarComponentUpdate baseFilters />

                            <LongitudeFamiliarComponentUpdate baseFilters />

                            <AcessoFamiliarComponentUpdate baseFilters />

                            <EmailFamiliarComponentUpdate baseFilters />

                            <CpfFamiliarComponentUpdate baseFilters />

                            <RgFamiliarComponentUpdate baseFilters />

                            <NascimentoFamiliarComponentUpdate baseFilters />

                            <SexoFamiliarComponentUpdate baseFilters />

                            <TelefoneFamiliarComponentUpdate baseFilters />

                            <CelularFamiliarComponentUpdate baseFilters />

                            <ObservacaoFamiliarComponentUpdate baseFilters />
                          </Row>
                        ...
                        <TabPane tabId={2}>
                          ...
                          <ComResponsavelComponentUpdate baseFilters />

                          <GrauParentescoComponentUpdate baseFilters grauParentescos />

                          <ResponsavelFamiliarComponentUpdate baseFilters />

                          <FranquiaComponentUpdate baseFilters franquias />
                          ...
                          <AphComponentUpdate baseFilters />

                          <NivelComplexidadeComponentUpdate baseFilters />

                          <PassagemPsComponentUpdate baseFilters />

                          <ObsPsComponentUpdate baseFilters />

                          <PassagemInternacaoComponentUpdate baseFilters />

                          <ObsInternacaoComponentUpdate baseFilters />

                          <CustoTotalComponentUpdate baseFilters />

                          <MesmoEnderecoComponentUpdate baseFilters />

                          <CadastroCompletoComponentUpdate baseFilters />

                          <AtivoComponentUpdate baseFilters />

                          <ExpoTokenComponentUpdate baseFilters />
...
const ProfissionalPrefComponentUpdate = ({ baseFilters, profissionals }) => {
  return baseFilters !== 'profissionalPref' ? (
    <Col md="6">
      <AvGroup>
        <Row>
          <Col md="12">
...
const TipohospitalComponentUpdate = ({ baseFilters, pacienteHospitals }) => {
  return baseFilters !== 'tipohospital' ? (
    <Col md="6">
      <AvGroup>
        <Row>
          <Col md="12">
          ...
          <Col md="12">
            <Select
              ...
              options={pacienteHospitals ? pacienteHospitals.map(option => ({ value: option.id, label: option.servico })) : null}
...
const LiminarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'liminar' ? (
    <Col md="liminar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const DetalhesComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'detalhes' ? (
    <Col md="detalhes">
      <AvGroup>
        <Row>
          <Col md="12">
...
const ComResponsavelComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'comResponsavel' ? (
...
const GrauParentescoComponentUpdate = ({ baseFilters, grauParentescos }) => {
        ...
        <Row>
          ...
          <Col md="12">
            <Select
              ...
              options={grauParentescos ? grauParentescos.map(option => ({ value: option.id, label: option.grauParentesco })) : null}
...
const ResponsavelFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'responsavelFamiliar' ? (
...
const CepFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'cepFamiliar' ? (
    <Col md="cepFamiliar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const EnderecoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'enderecoFamiliar' ? (
...
const NumeroFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'numeroFamiliar' ? (
...
const ComplementoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'complementoFamiliar' ? (
...
const CidadeFamiliarComponentUpdate = ({ baseFilters, cidades }) => {
  return baseFilters !== 'cidadeFamiliar' ? (
    <Col md="12">
      <AvGroup>
        <Row>
          <Col md="12">
...
const BairroFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'bairroFamiliar' ? (
...
const UfFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'ufFamiliar' ? (
    <Col md="ufFamiliar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const LatitudeFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'latitudeFamiliar' ? (
...
const LongitudeFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'longitudeFamiliar' ? (
...
const AcessoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'acessoFamiliar' ? (
...
const EmailFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'emailFamiliar' ? (
...
const CpfFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'cpfFamiliar' ? (
    <Col md="cpfFamiliar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const RgFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'rgFamiliar' ? (
    <Col md="rgFamiliar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const NascimentoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'nascimentoFamiliar' ? (
...
const SexoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'sexoFamiliar' ? (
    <Col md="sexoFamiliar">
      <AvGroup>
        <Row>
          <Col md="12">
...
const TelefoneFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'telefoneFamiliar' ? (
...
const CelularFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'celularFamiliar' ? (
...
const ObservacaoFamiliarComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'observacaoFamiliar' ? (
...
const AphComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'aph' ? (
    <Col md="aph">
      <AvGroup>
        <Row>
          <Col md="12">
...
const NivelComplexidadeComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'nivelComplexidade' ? (
...
const PassagemPsComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'passagemPs' ? (
    <Col md="passagemPs">
      <AvGroup>
        <Row>
          <Col md="12">
...
const ObsPsComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'obsPs' ? (
    <Col md="obsPs">
      <AvGroup>
        <Row>
          <Col md="12">
...
const PassagemInternacaoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'passagemInternacao' ? (
...
const ObsInternacaoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'obsInternacao' ? (
...
const CustoTotalComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'custoTotal' ? (
    <Col md="custoTotal">
      <AvGroup>
        <Row>
          <Col md="12">
...
const MesmoEnderecoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'mesmoEndereco' ? (
...
const CadastroCompletoComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'cadastroCompleto' ? (
...
const ExpoTokenComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'expoToken' ? (
    <Col md="expoToken">
      <AvGroup>
        <Row>
          <Col md="12">
