                      ...
                      <td className="text-right">
                        <Dropdown isOpen={this.state.dropdownButtons[i]} toggle={() => this.toggle(i)}>
                          ...
                          <DropdownMenu right>
                            ...
                            <DropdownItem tag={Link} to={`/paciente/${paciente.id}/paciente-arquivo?`} color="info" size="sm">
                            ...
                            <DropdownItem tag={Link} to={`/paciente-?baseFilters=paciente&paciente=${paciente.id}`} color="info" size="sm">
                            ...
                            <DropdownItem tag={Link} to={`/paciente-?baseFilters=paciente&paciente=${paciente.id}`} color="info" size="sm">
                              <FontAwesomeIcon icon="list" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="generadorApp.paciente.listButtons.TratamentoIndicado">TratamentoIndicado</Translate>
                              </span>
                            </DropdownItem>
                          </DropdownMenu>
                        </Dropdown>
