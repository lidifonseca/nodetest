...
export class PacienteDiarioTagsUpdate extends React.Component<IPacienteDiarioTagsUpdateProps, IPacienteDiarioTagsUpdateState> {
  ...
  getFiltersURL = (offset = null) => {
    ...
    return (
      ...
      (fieldsBase['idPacienteDiario'] ? '&idPacienteDiario=' + fieldsBase['idPacienteDiario'] : '') +
      (fieldsBase['idDiarioTags'] ? '&idDiarioTags=' + fieldsBase['idDiarioTags'] : '') +
      (fieldsBase['escalaDePlantao'] ? '&escalaDePlantao=' + fieldsBase['escalaDePlantao'] : '') +
      (fieldsBase['captacaoEdp'] ? '&captacaoEdp=' + fieldsBase['captacaoEdp'] : '') +
      (fieldsBase['implantacaoEdp'] ? '&implantacaoEdp=' + fieldsBase['implantacaoEdp'] : '') +
      (fieldsBase['furoDeEscalaEdp'] ? '&furoDeEscalaEdp=' + fieldsBase['furoDeEscalaEdp'] : '') +
      (fieldsBase['solicitacaoDeFolgaEdp'] ? '&solicitacaoDeFolgaEdp=' + fieldsBase['solicitacaoDeFolgaEdp'] : '') +
      (fieldsBase['trocaDeProfissionalEdp'] ? '&trocaDeProfissionalEdp=' + fieldsBase['trocaDeProfissionalEdp'] : '') +
      (fieldsBase['reclamacaoEdp'] ? '&reclamacaoEdp=' + fieldsBase['reclamacaoEdp'] : '') +
      (fieldsBase['elogioEdp'] ? '&elogioEdp=' + fieldsBase['elogioEdp'] : '') +
      (fieldsBase['recusaDeAtendimentoEdp'] ? '&recusaDeAtendimentoEdp=' + fieldsBase['recusaDeAtendimentoEdp'] : '') +
      (fieldsBase['duplicidadeEdp'] ? '&duplicidadeEdp=' + fieldsBase['duplicidadeEdp'] : '') +
      (fieldsBase['monitorarEdp'] ? '&monitorarEdp=' + fieldsBase['monitorarEdp'] : '') +
      (fieldsBase['pendenteEdp'] ? '&pendenteEdp=' + fieldsBase['pendenteEdp'] : '') +
      (fieldsBase['escalaMultiProfissional'] ? '&escalaMultiProfissional=' + fieldsBase['escalaMultiProfissional'] : '') +
      (fieldsBase['captacaoEmp'] ? '&captacaoEmp=' + fieldsBase['captacaoEmp'] : '') +
      (fieldsBase['implantacaoEmp'] ? '&implantacaoEmp=' + fieldsBase['implantacaoEmp'] : '') +
      (fieldsBase['solicitacaoDeFolgaEmp'] ? '&solicitacaoDeFolgaEmp=' + fieldsBase['solicitacaoDeFolgaEmp'] : '') +
      (fieldsBase['trocaDeProfissionalEmp'] ? '&trocaDeProfissionalEmp=' + fieldsBase['trocaDeProfissionalEmp'] : '') +
      (fieldsBase['reclamacaoEmp'] ? '&reclamacaoEmp=' + fieldsBase['reclamacaoEmp'] : '') +
      (fieldsBase['elogioEmp'] ? '&elogioEmp=' + fieldsBase['elogioEmp'] : '') +
      (fieldsBase['padIncompletoEmp'] ? '&padIncompletoEmp=' + fieldsBase['padIncompletoEmp'] : '') +
      (fieldsBase['visitaImprodutivaEmp'] ? '&visitaImprodutivaEmp=' + fieldsBase['visitaImprodutivaEmp'] : '') +
      (fieldsBase['monitorarEmp'] ? '&monitorarEmp=' + fieldsBase['monitorarEmp'] : '') +
      (fieldsBase['pendenteEmp'] ? '&pendenteEmp=' + fieldsBase['pendenteEmp'] : '') +
      (fieldsBase['intercorrencia'] ? '&intercorrencia=' + fieldsBase['intercorrencia'] : '') +
      (fieldsBase['clinicaInter'] ? '&clinicaInter=' + fieldsBase['clinicaInter'] : '') +
      (fieldsBase['aphInter'] ? '&aphInter=' + fieldsBase['aphInter'] : '') +
      (fieldsBase['pendenteInter'] ? '&pendenteInter=' + fieldsBase['pendenteInter'] : '') +
      (fieldsBase['solicitacoes'] ? '&solicitacoes=' + fieldsBase['solicitacoes'] : '') +
      (fieldsBase['recargaDeOxigenioSolic'] ? '&recargaDeOxigenioSolic=' + fieldsBase['recargaDeOxigenioSolic'] : '') +
      (fieldsBase['equipamentosSolic'] ? '&equipamentosSolic=' + fieldsBase['equipamentosSolic'] : '') +
      (fieldsBase['matmedSolic'] ? '&matmedSolic=' + fieldsBase['matmedSolic'] : '') +
      (fieldsBase['prontuarioSolic'] ? '&prontuarioSolic=' + fieldsBase['prontuarioSolic'] : '') +
      (fieldsBase['prescricoesSolic'] ? '&prescricoesSolic=' + fieldsBase['prescricoesSolic'] : '') +
      (fieldsBase['examesSolic'] ? '&examesSolic=' + fieldsBase['examesSolic'] : '') +
      (fieldsBase['ambulanciaSolic'] ? '&ambulanciaSolic=' + fieldsBase['ambulanciaSolic'] : '') +
      (fieldsBase['atendimentoDeEquipeSolic'] ? '&atendimentoDeEquipeSolic=' + fieldsBase['atendimentoDeEquipeSolic'] : '') +
      (fieldsBase['monitorarSolic'] ? '&monitorarSolic=' + fieldsBase['monitorarSolic'] : '') +
      (fieldsBase['pendenteSolic'] ? '&pendenteSolic=' + fieldsBase['pendenteSolic'] : '') +
      (fieldsBase['avaliacao'] ? '&avaliacao=' + fieldsBase['avaliacao'] : '') +
      (fieldsBase['residenciaAval'] ? '&residenciaAval=' + fieldsBase['residenciaAval'] : '') +
      (fieldsBase['hospitalAval'] ? '&hospitalAval=' + fieldsBase['hospitalAval'] : '') +
      (fieldsBase['monitorarAval'] ? '&monitorarAval=' + fieldsBase['monitorarAval'] : '') +
      (fieldsBase['captacaoAtivaAval'] ? '&captacaoAtivaAval=' + fieldsBase['captacaoAtivaAval'] : '') +
      (fieldsBase['pendenteAval'] ? '&pendenteAval=' + fieldsBase['pendenteAval'] : '') +
      (fieldsBase['implantacao'] ? '&implantacao=' + fieldsBase['implantacao'] : '') +
      (fieldsBase['monitorarImpl'] ? '&monitorarImpl=' + fieldsBase['monitorarImpl'] : '') +
      (fieldsBase['pendenteImpl'] ? '&pendenteImpl=' + fieldsBase['pendenteImpl'] : '') +
      (fieldsBase['alta'] ? '&alta=' + fieldsBase['alta'] : '') +
      (fieldsBase['hospitalizacaoAlt'] ? '&hospitalizacaoAlt=' + fieldsBase['hospitalizacaoAlt'] : '') +
      (fieldsBase['migracaoDeEmpresaAlt'] ? '&migracaoDeEmpresaAlt=' + fieldsBase['migracaoDeEmpresaAlt'] : '') +
      (fieldsBase['obitoEmCasaAlt'] ? '&obitoEmCasaAlt=' + fieldsBase['obitoEmCasaAlt'] : '') +
      (fieldsBase['terminoDeAtendimentoAlt'] ? '&terminoDeAtendimentoAlt=' + fieldsBase['terminoDeAtendimentoAlt'] : '') +
      (fieldsBase['atendimentoSuspensoAlt'] ? '&atendimentoSuspensoAlt=' + fieldsBase['atendimentoSuspensoAlt'] : '') +
      (fieldsBase['monitorarAlt'] ? '&monitorarAlt=' + fieldsBase['monitorarAlt'] : '') +
      (fieldsBase['pendenteAlt'] ? '&pendenteAlt=' + fieldsBase['pendenteAlt'] : '') +
      (fieldsBase['eCommerceSegViagem'] ? '&eCommerceSegViagem=' + fieldsBase['eCommerceSegViagem'] : '') +
      (fieldsBase['monitorarEcsv'] ? '&monitorarEcsv=' + fieldsBase['monitorarEcsv'] : '') +
      (fieldsBase['pendenteEcsv'] ? '&pendenteEcsv=' + fieldsBase['pendenteEcsv'] : '') +
      (fieldsBase['farmacia'] ? '&farmacia=' + fieldsBase['farmacia'] : '') +
      (fieldsBase['matMedFarm'] ? '&matMedFarm=' + fieldsBase['matMedFarm'] : '') +
      (fieldsBase['receitaFarm'] ? '&receitaFarm=' + fieldsBase['receitaFarm'] : '') +
      (fieldsBase['prontuarioFarm'] ? '&prontuarioFarm=' + fieldsBase['prontuarioFarm'] : '') +
      (fieldsBase['romaneioManualFarm'] ? '&romaneioManualFarm=' + fieldsBase['romaneioManualFarm'] : '') +
      (fieldsBase['outrosFarm'] ? '&outrosFarm=' + fieldsBase['outrosFarm'] : '') +
      (fieldsBase['monitorarFarm'] ? '&monitorarFarm=' + fieldsBase['monitorarFarm'] : '') +
      (fieldsBase['pendenteFarm'] ? '&pendenteFarm=' + fieldsBase['pendenteFarm'] : '') +
      (fieldsBase['contatoTelefonico'] ? '&contatoTelefonico=' + fieldsBase['contatoTelefonico'] : '') +
      (fieldsBase['ativoContTel'] ? '&ativoContTel=' + fieldsBase['ativoContTel'] : '') +
      (fieldsBase['receptivoContTel'] ? '&receptivoContTel=' + fieldsBase['receptivoContTel'] : '') +
      (fieldsBase['monitorarContTel'] ? '&monitorarContTel=' + fieldsBase['monitorarContTel'] : '') +
      (fieldsBase['pendenteContTel'] ? '&pendenteContTel=' + fieldsBase['pendenteContTel'] : '') +
      (fieldsBase['dtPost'] ? '&dtPost=' + fieldsBase['dtPost'] : '') +
      ''
    );
  };
