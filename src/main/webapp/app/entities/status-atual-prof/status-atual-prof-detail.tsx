    ...
    return (
      <div>
        <ol className="breadcrumb float-xl-right">
          ...
          <li className="breadcrumb-item active">Status Atual Profs details</li>
        </ol>
        ...
        <Panel>
          ...
          <PanelBody>
            <Row>
              <Col md="8">
                <h2>
                  <Translate contentKey="generadorApp.statusAtualProf.detail.title">StatusAtualProf</Translate>[
                  <b>{statusAtualProfEntity.id}</b>]
                </h2>
                <Row className="jh-entity-details">
                  ...
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>{statusAtualProfEntity.styleLabel}</dd>
                      </Col>
                    </Row>
                  </Col>
                </Row>
                <Button tag={Link} to="/status-atual-prof" replace color="info">
                ...
                &nbsp;
                <Button tag={Link} to={`/status-atual-prof/${statusAtualProfEntity.id}/edit`} replace color="primary">
...
export default connect(mapStateToProps, mapDispatchToProps)(StatusAtualProfDetail);
