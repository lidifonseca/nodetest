...
import StatusAtualProfRelatorioCSV from './relatorio/status-atual-prof.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={StatusAtualProfRelatorioCSV} />
