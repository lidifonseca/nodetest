...
import { getEntity, updateEntity, createEntity, reset } from './licao-casa-evolucao.reducer';
...
export class LicaoCasaEvolucaoUpdate extends React.Component<ILicaoCasaEvolucaoUpdateProps, ILicaoCasaEvolucaoUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/licao-casa-evolucao');
  };
            ...
            <PanelHeader>
              <h2 id="page-heading">
                <span className="page-header ml-3">
                  <Translate contentKey="generadorApp.licaoCasaEvolucao.home.createOrEditLabel">
                    Create or edit a LicaoCasaEvolucao
                  </Translate>
                </span>
                ...
                <Button tag={Link} id="cancel-save" to="/licao-casa-evolucao" replace color="info" className="float-right jh-create-entity">
