...
export class LicaoCasaEvolucaoUpdate extends React.Component<ILicaoCasaEvolucaoUpdateProps, ILicaoCasaEvolucaoUpdateState> {
  ...
  getFiltersURL = (offset = null) => {
    ...
    return (
      ...
      (fieldsBase['licaoCasaId'] ? '&licaoCasaId=' + fieldsBase['licaoCasaId'] : '') +
      (fieldsBase['atualizadoEm'] ? '&atualizadoEm=' + fieldsBase['atualizadoEm'] : '') +
      (fieldsBase['realizada'] ? '&realizada=' + fieldsBase['realizada'] : '') +
      (fieldsBase['realizadaEm'] ? '&realizadaEm=' + fieldsBase['realizadaEm'] : '') +
      (fieldsBase['observacoes'] ? '&observacoes=' + fieldsBase['observacoes'] : '') +
      (fieldsBase['instrucoes'] ? '&instrucoes=' + fieldsBase['instrucoes'] : '') +
      (fieldsBase['dataAgenda'] ? '&dataAgenda=' + fieldsBase['dataAgenda'] : '') +
      (fieldsBase['qtdLembrete'] ? '&qtdLembrete=' + fieldsBase['qtdLembrete'] : '') +
      ''
    );
  };
