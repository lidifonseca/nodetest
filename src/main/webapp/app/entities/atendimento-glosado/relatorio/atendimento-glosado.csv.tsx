...
import { getAtendimentoGlosadoState, IAtendimentoGlosadoBaseState, getEntitiesExport } from '../atendimento-glosado.reducer';
...
export class AtendimentoGlosado extends React.Component<IAtendimentoGlosadoProps, IAtendimentoGlosadoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idAtendimento, glosado, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
