...
import AtendimentoGlosadoRelatorioCSV from './relatorio/atendimento-glosado.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={AtendimentoGlosadoRelatorioCSV} />
