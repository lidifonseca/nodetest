                ...
                <Row className="jh-entity-details">
                  ...
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>
                          <TextFormat value={padItemResultadoEntity.dataPost} type="date" format={APP_DATE_FORMAT} />
                        </dd>
                      </Col>
                    </Row>
                  </Col>
                  ...
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>{padItemResultadoEntity.idPadItem ? padItemResultadoEntity.idPadItem.id : ''}</dd>
                      </Col>
                    </Row>
                  </Col>
                </Row>
