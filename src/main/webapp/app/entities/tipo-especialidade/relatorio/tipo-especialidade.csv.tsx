...
import { getTipoEspecialidadeState, ITipoEspecialidadeBaseState, getEntitiesExport } from '../tipo-especialidade.reducer';
...
export class TipoEspecialidade extends React.Component<ITipoEspecialidadeProps, ITipoEspecialidadeState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(tipoEspecialidade, especialidade, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
