...
import { getEntity, updateEntity, createEntity, reset } from './tipo-especialidade.reducer';
...
export class TipoEspecialidadeUpdate extends React.Component<ITipoEspecialidadeUpdateProps, ITipoEspecialidadeUpdateState> {
  ...
  handleClose = () => {
    this.props.history.push('/tipo-especialidade');
  };
          ...
          <Panel>
            <PanelHeader>
              <h2 id="page-heading">
                ...
                <Button tag={Link} id="cancel-save" to="/tipo-especialidade" replace color="info" className="float-right jh-create-entity">
                    ...
                    <Row>
                      ...
                      <Col md="12">
                        <AvGroup>
                          <Row>
                            <Col md="3">
                              <Label className="mt-2" id="dataPostLabel" for="tipo-especialidade-dataPost">
                            ...
                            <Col md="9">
                              <AvInput
                                ...
                                value={isNew ? null : convertDateTimeFromServer(this.props.tipoEspecialidadeEntity.dataPost)}
                                validate={{
