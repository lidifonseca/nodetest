...
import TipoEspecialidadeRelatorioCSV from './relatorio/tipo-especialidade.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={TipoEspecialidadeRelatorioCSV} />
