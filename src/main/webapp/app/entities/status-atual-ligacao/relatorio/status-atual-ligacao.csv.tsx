...
import { getStatusAtualLigacaoState, IStatusAtualLigacaoBaseState, getEntitiesExport } from '../status-atual-ligacao.reducer';
...
export class StatusAtualLigacao extends React.Component<IStatusAtualLigacaoProps, IStatusAtualLigacaoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(statusAtualLigacao, styleLabel, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
