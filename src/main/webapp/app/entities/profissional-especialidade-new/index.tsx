...
import ProfissionalEspecialidadeNewRelatorioCSV from './relatorio/profissional-especialidade-new.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalEspecialidadeNewRelatorioCSV} />
