                ...
                <Col md="8">
                  {loading ? (
                    ...
                    <div>
                      ...
                      <Row>
                        <RespostaComponentUpdate baseFilters />
...
const RespostaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'resposta' ? (
    <Col md="resposta">
      <AvGroup>
        <Row>
          <Col md="3">
...
const RespostaAtivaComponentUpdate = ({ baseFilters }) => {
  return baseFilters !== 'respostaAtiva' ? (
