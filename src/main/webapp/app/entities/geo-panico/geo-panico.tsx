...
import { getEntities } from './geo-panico.reducer';
...
export class GeoPanico extends React.Component<IGeoPanicoProps, IGeoPanicoState> {
  ...
  constructor(props: IGeoPanicoProps) {
    ...
    this.state = {
      ...
      ...this.getGeoPanicoState(this.props.location)
    };
  }

  getGeoPanicoState = (location): IGeoPanicoBaseState => {
                  ...
                  <tbody>
                    ...
                    {geoPanicoList.map((geoPanico, i) => (
                      <tr key={`entity-${i}`}>
                        ...
                        <td>{geoPanico.idPanico}</td>

                        <td>{geoPanico.idPaciente}</td>
                        ...
                        <td className="text-right">
                          <div className="btn-group flex-btn-group-container">
                            <Button tag={Link} to={`${match.url}/${geoPanico.id}`} color="info" size="sm">
                              <FontAwesomeIcon icon="eye" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.view">View</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${geoPanico.id}/edit`} color="primary" size="sm">
                              <FontAwesomeIcon icon="pencil-alt" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.edit">Edit</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${geoPanico.id}/delete`} color="danger" size="sm">
