...
import { getGeoPanicoState, IGeoPanicoBaseState, getEntitiesExport } from '../geo-panico.reducer';
...
export class GeoPanico extends React.Component<IGeoPanicoProps, IGeoPanicoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPanico, idPaciente, latitude, longitude, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
