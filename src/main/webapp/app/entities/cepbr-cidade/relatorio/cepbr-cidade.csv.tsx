...
import { getCepbrCidadeState, ICepbrCidadeBaseState, getEntitiesExport } from '../cepbr-cidade.reducer';
...
export class CepbrCidade extends React.Component<ICepbrCidadeProps, ICepbrCidadeState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idCidade, cidade, codIbge, area, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
