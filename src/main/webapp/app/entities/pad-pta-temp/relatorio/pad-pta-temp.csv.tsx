...
import { getPadPtaTempState, IPadPtaTempBaseState, getEntitiesExport } from '../pad-pta-temp.reducer';
...
export class PadPtaTemp extends React.Component<IPadPtaTempProps, IPadPtaTempState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(sessionId, idPta, idCid, cidXPtaNovoId, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
