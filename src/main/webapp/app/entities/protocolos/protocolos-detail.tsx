    ...
    return (
      <div>
        <ol className="breadcrumb float-xl-right">
          ...
          <li className="breadcrumb-item active">Protocolos details</li>
        </ol>
        ...
        <Panel>
          ...
          <PanelBody>
            <Row>
              <Col md="8">
                <h2>
                  <Translate contentKey="generadorApp.protocolos.detail.title">Protocolos</Translate>[<b>{protocolosEntity.id}</b>]
                </h2>
                <Row className="jh-entity-details">
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>{protocolosEntity.protocolo}</dd>
                      </Col>
                    </Row>
                  </Col>
                </Row>
                <Button tag={Link} to="/protocolos" replace color="info">
                ...
                &nbsp;
                <Button tag={Link} to={`/protocolos/${protocolosEntity.id}/edit`} replace color="primary">
...
const mapStateToProps = ({ protocolos }: IRootState) => ({
  protocolosEntity: protocolos.entity
});
...
export default connect(mapStateToProps, mapDispatchToProps)(ProtocolosDetail);
