...
import AtendimentoAtividadesRelatorioCSV from './relatorio/atendimento-atividades.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={AtendimentoAtividadesRelatorioCSV} />
