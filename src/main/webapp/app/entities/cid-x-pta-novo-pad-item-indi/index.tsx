...
import CidXPtaNovoPadItemIndiRelatorioCSV from './relatorio/cid-x-pta-novo-pad-item-indi.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={CidXPtaNovoPadItemIndiRelatorioCSV} />
