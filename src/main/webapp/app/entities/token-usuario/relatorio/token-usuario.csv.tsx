...
import { getTokenUsuarioState, ITokenUsuarioBaseState, getEntitiesExport } from '../token-usuario.reducer';
...
export class TokenUsuario extends React.Component<ITokenUsuarioProps, ITokenUsuarioState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPaciente, token, dataValida, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
