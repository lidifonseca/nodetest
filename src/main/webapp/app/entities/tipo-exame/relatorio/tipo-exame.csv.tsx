...
import { getTipoExameState, ITipoExameBaseState, getEntitiesExport } from '../tipo-exame.reducer';
...
export class TipoExame extends React.Component<ITipoExameProps, ITipoExameState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(exame, idPai, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
