...
import { getProfissionalPushState, IProfissionalPushBaseState, getEntitiesExport } from '../profissional-push.reducer';
...
export class ProfissionalPush extends React.Component<IProfissionalPushProps, IProfissionalPushState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idProfissional, idFranquia, mensagem, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
