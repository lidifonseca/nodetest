...
import { getTempoExperienciaState, ITempoExperienciaBaseState, getEntities } from './tempo-experiencia.reducer';
...
export class TempoExperiencia extends React.Component<ITempoExperienciaProps, ITempoExperienciaState> {
  ...
  constructor(props: ITempoExperienciaProps) {
    ...
    this.state = {
      ...
      ...getTempoExperienciaState(this.props.location)
    };
  }
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="page-heading">
          <span className="page-header">Tempo Experiencias</span>
          <Button id="togglerFilterTempoExperiencia" className="btn btn-primary float-right jh-create-entity">
            <Translate contentKey="generadorApp.tempoExperiencia.home.btn_filter_open">Filters</Translate>
            &nbsp;
                ...
                <CardBody>
                  <AvForm ref={el => (this.myFormRef = el)} id="form-filter" onSubmit={this.filterEntity}>
                    <div className="row mt-1 ml-3 mr-3">
                      {this.state.baseFilters !== 'tempoExperiencia' ? (
                        <Col md="3">
                    ...
                    <div className="row mb-2 mr-4 justify-content-end">
                      <Button className="btn btn-success" type="submit">
                        ...
                        &nbsp;
                        <Translate contentKey="generadorApp.tempoExperiencia.home.btn_filter">Filter</Translate>
                      </Button>
                      &nbsp;
                      <div className="btn btn-secondary hand" onClick={this.cancelCourse}>
                        <FontAwesomeIcon icon="trash-alt" />
                        &nbsp;
                        <Translate contentKey="generadorApp.tempoExperiencia.home.btn_filter_clean">Clean</Translate>
                      </div>
                    </div>
                  </AvForm>
                </CardBody>
                  ...
                  <tbody>
                    ...
                    {tempoExperienciaList.map((tempoExperiencia, i) => (
                      <tr key={`entity-${i}`}>
                        ...
                        {this.state.baseFilters !== 'tempoExperiencia' ? <td>{tempoExperiencia.tempoExperiencia}</td> : null}

                        <td className="text-right">
                          <div className="btn-group flex-btn-group-container">
                            <Button tag={Link} to={`${match.url}/${tempoExperiencia.id}?${this.getFiltersURL()}`} color="info" size="sm">
                            ...
                            <Button
                              tag={Link}
                              to={`${match.url}/${tempoExperiencia.id}/edit?${this.getFiltersURL()}`}
                              color="primary"
                              size="sm"
                            >
                            ...
                            <Button
                              tag={Link}
                              to={`${match.url}/${tempoExperiencia.id}/delete?${this.getFiltersURL()}`}
                              color="danger"
                              size="sm"
                            >
