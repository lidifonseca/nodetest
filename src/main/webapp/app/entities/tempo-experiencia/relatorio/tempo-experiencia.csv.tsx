...
import { getTempoExperienciaState, ITempoExperienciaBaseState, getEntitiesExport } from '../tempo-experiencia.reducer';
...
export class TempoExperiencia extends React.Component<ITempoExperienciaProps, ITempoExperienciaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(tempoExperiencia, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
