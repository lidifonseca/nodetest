...
import { getPadPtaState, IPadPtaBaseState, getEntitiesExport } from '../pad-pta.reducer';
...
export class PadPta extends React.Component<IPadPtaProps, IPadPtaState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idPad, idDescPta, idCid, idCidXPtaNovo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
