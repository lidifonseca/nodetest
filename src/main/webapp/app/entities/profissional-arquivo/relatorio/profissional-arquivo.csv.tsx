...
import { getProfissionalArquivoState, IProfissionalArquivoBaseState, getEntitiesExport } from '../profissional-arquivo.reducer';
...
export class ProfissionalArquivo extends React.Component<IProfissionalArquivoProps, IProfissionalArquivoState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idProfissional, arquivo, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
