...
import PacienteProntuarioRelatorioCSV from './relatorio/paciente-prontuario.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacienteProntuarioRelatorioCSV} />
