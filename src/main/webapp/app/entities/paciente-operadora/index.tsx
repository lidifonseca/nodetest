...
import PacienteOperadoraRelatorioCSV from './relatorio/paciente-operadora.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={PacienteOperadoraRelatorioCSV} />
