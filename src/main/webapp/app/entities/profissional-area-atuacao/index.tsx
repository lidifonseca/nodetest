...
import ProfissionalAreaAtuacaoRelatorioCSV from './relatorio/profissional-area-atuacao.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalAreaAtuacaoRelatorioCSV} />
