...
import { getEntity } from './profissional-area-atuacao.reducer';
...
export class ProfissionalAreaAtuacaoDetail extends React.Component<IProfissionalAreaAtuacaoDetailProps> {
                  ...
                  <Col md="12">
                    <Row>
                      <Col md="3">
                        <dt>
                          <span id="dataPost">
                            <Translate contentKey="generadorApp.profissionalAreaAtuacao.dataPost">Data Post</Translate>
                          </span>
                        </dt>
                      </Col>
                      <Col md="9">
                        <dd>
                          <TextFormat value={profissionalAreaAtuacaoEntity.dataPost} type="date" format={APP_DATE_FORMAT} />
                        </dd>
                      </Col>
                    </Row>
                  </Col>
