...
import ProfissionalStatusAtualRelatorioCSV from './relatorio/profissional-status-atual.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalStatusAtualRelatorioCSV} />
