...
import AtendimentoAceiteRelatorioCSV from './relatorio/atendimento-aceite.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={AtendimentoAceiteRelatorioCSV} />
