...
import ProfissionalNewRelatorioCSV from './relatorio/profissional-new.csv';
...
const Routes = ({ match }) => (
  <>
    <Switch>
      <ErrorBoundaryRoute exact path={`${match.url}/relatorio/csv`} component={ProfissionalNewRelatorioCSV} />
