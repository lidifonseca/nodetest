...
import { getEntity } from './profissional-new.reducer';
...
export class ProfissionalNewDetail extends React.Component<IProfissionalNewDetailProps> {
                ...
                <Row className="jh-entity-details">
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>{profissionalNewEntity.idUnidade}</dd>
                      </Col>
                    </Row>
                  </Col>
                  ...
                  <Col md="12">
                    <Row>
                      ...
                      <Col md="9">
                        <dd>
                          <TextFormat value={profissionalNewEntity.dataPost} type="date" format={APP_DATE_FORMAT} />
                        </dd>
                      </Col>
                    </Row>
                  </Col>
