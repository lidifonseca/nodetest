...
export class ComarcaDeleteDialog extends React.Component<IComarcaDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.comarcaEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="tjscrapperApp.comarca.delete.question">
          <Translate contentKey="tjscrapperApp.comarca.delete.question" interpolate={{ id: comarcaEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-comarca" color="danger" onClick={this.confirmDelete}>
