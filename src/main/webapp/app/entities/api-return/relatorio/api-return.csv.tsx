...
import { getApiReturnState, IApiReturnBaseState, getEntitiesExport } from '../api-return.reducer';
...
export class ApiReturn extends React.Component<IApiReturnProps, IApiReturnState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(idApiName, apiReturn, apiType, obs, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
