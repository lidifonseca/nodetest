...
import { getAtendimentoImagemState, IAtendimentoImagemBaseState, getEntitiesExport } from '../atendimento-imagem.reducer';
...
export class AtendimentoImagem extends React.Component<IAtendimentoImagemProps, IAtendimentoImagemState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(atendimentoId, imagem, criadoEm, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
