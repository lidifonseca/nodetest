...
import { getTipoOperadoraState, ITipoOperadoraBaseState, getEntitiesExport } from '../tipo-operadora.reducer';
...
export class TipoOperadora extends React.Component<ITipoOperadoraProps, ITipoOperadoraState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(tipo, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
