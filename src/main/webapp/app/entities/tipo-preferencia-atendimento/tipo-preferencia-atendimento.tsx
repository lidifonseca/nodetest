...
import { getEntities } from './tipo-preferencia-atendimento.reducer';
...
export class TipoPreferenciaAtendimento extends React.Component<ITipoPreferenciaAtendimentoProps, ITipoPreferenciaAtendimentoState> {
  ...
  constructor(props: ITipoPreferenciaAtendimentoProps) {
    ...
    this.state = {
      ...
      ...this.getTipoPreferenciaAtendimentoState(this.props.location)
    };
  }

  getTipoPreferenciaAtendimentoState = (location): ITipoPreferenciaAtendimentoBaseState => {
                  ...
                  <tbody>
                    ...
                    {tipoPreferenciaAtendimentoList.map((tipoPreferenciaAtendimento, i) => (
                      <tr key={`entity-${i}`}>
                        ...
                        <td>{tipoPreferenciaAtendimento.nome}</td>

                        <td>{tipoPreferenciaAtendimento.ativo}</td>

                        <td className="text-right">
                          <div className="btn-group flex-btn-group-container">
                            <Button tag={Link} to={`${match.url}/${tipoPreferenciaAtendimento.id}`} color="info" size="sm">
                              <FontAwesomeIcon icon="eye" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.view">View</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${tipoPreferenciaAtendimento.id}/edit`} color="primary" size="sm">
                              <FontAwesomeIcon icon="pencil-alt" />{' '}
                              <span className="d-none d-md-inline">
                                <Translate contentKey="entity.action.edit">Edit</Translate>
                              </span>
                            </Button>
                            <Button tag={Link} to={`${match.url}/${tipoPreferenciaAtendimento.id}/delete`} color="danger" size="sm">
