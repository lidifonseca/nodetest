...
import { getApiNameState, IApiNameBaseState, getEntitiesExport } from '../api-name.reducer';
...
export class ApiName extends React.Component<IApiNameProps, IApiNameState> {
  ...
  getEntities = () => {
    ...
    this.props.getEntitiesExport(apiName, apiReceiver, apiObs, ativo, activePage - 1, itemsPerPage, `${sort},${order}`);
  };
